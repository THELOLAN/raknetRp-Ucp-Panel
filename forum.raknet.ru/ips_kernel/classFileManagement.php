 ...
 * Last Updated: $Date: 2015-04-22 12:58:04 -0400 (Wed, 22 Apr 2015) $
 * </pre>
 *
...
class classFileManagement
{
	...
	protected function _getContentsWithSocket( $file_location, $post_array=array() )
	{
		...
		else
		{
			...
			if ( $post_back_str !== FALSE )
			{
				$header .= $post_back_str;
			}
	...
	{	
		...
		{		
			...
			if ( $data )
			{
				$this->raw_headers = substr( $data, 0, $info['header_size'] );
