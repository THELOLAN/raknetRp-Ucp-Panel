 ...
 * IP.Board v3.4.8
 * Forum management
 * Last Updated: $Date: 2013-03-21 11:03:13 -0400 (Thu, 21 Mar 2013) $
 * </pre>
 *
...
class admin_forums_forums_forums extends ipsCommand
{
	...
	public function doRules()
	{
		...
		$text = $_editor->process( $_POST['body'] );
	...
	public function forumSave( $type='new' )
	{
		...
		$save = array(	'name'						=> IPSText::getTextClass('bbcode')->xssHtmlClean( nl2br( IPSText::stripslashes( $_POST['name'] ) ) ),
						'name_seo'					=> IPSText::makeSeoTitle( strip_tags( IPSText::UNhtmlspecialchars( $this->request['name'] ) ) ),
