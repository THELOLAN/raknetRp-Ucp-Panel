 ...
 * Last Updated: $Date: 2013-11-15 13:16:48 -0500 (Fri, 15 Nov 2013) $
 * </pre>
 *
	...
	protected function _showLeaders()
 	{
		...
		if ( count( $group_ids ) )
		{
			$whereClause[] = "m.member_group_id IN(" . IPSText::cleanPermString( implode( ',', array_keys( $group_ids ) ) ) . ")";
		}
		...
		if ( count( $member_ids ) )
		{
			$whereClause[] = "m.member_id IN(" . IPSText::cleanPermString( implode( ',', array_keys( $member_ids ) ) ) . ")";
		}
