 ...
 * IP.Board v3.4.8
 * Posting
 * Last Updated: $Date: 2013-01-29 18:38:34 -0500 (Tue, 29 Jan 2013) $
 * </pre>
...
class public_forums_post_post extends ipsCommand
{
    ...
    public function doExecute( ipsRegistry $registry )
    {
        ...
        if ( ! is_string( $do ) || ! isset( $doCodes[ $do ] ) )
        {
		...
		switch( $type )
		{
			case 'reply':
				try
				{
					...
					/* Bug #40789 This is no longer required since findpost additions in 3.4
