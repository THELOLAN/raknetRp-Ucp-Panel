 ...
 * $Author: rashbrook $
 * @since		-
 * $LastChangedDate: 2014-08-29 15:04:48 -0400 (Fri, 29 Aug 2014) $
 * @version		v3.4.8
 * $Revision: 12492 $
 */
...
class task_item
{
	...
	public function runTask()
	{
		...
		$this->DB->build( array( "select" => '*', 'from' => 'attachments',  'where' => "attach_rel_id=0 AND attach_date < {$time_cutoff}", 'limit' => array( 0, 25 ) ) );
		$this->DB->execute();
