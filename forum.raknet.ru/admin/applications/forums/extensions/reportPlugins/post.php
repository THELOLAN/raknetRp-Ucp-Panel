 ...
 * Last Updated: $LastChangedDate: 2013-12-13 13:41:34 -0500 (Fri, 13 Dec 2013) $
 * </pre>
 *
...
class post_plugin
{
	...
	public function processReport( $com_dat )
	{
		...
		$url		= 'app=forums&module=forums&section=findpost&pid=' . intval( $post_id );
		...
		$message = $this->registry->output->parseIPSTags( $parser->buildQuoteTag( $data['post'], $data['members_display_name'], $data['post_date'], 0, $data['pid'] ) );
