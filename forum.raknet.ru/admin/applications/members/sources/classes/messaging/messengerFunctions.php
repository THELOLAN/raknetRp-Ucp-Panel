 ...
 * IP.Board v3.4.8
 * Comments library
 * Last Updated: $Date: 2014-09-26 16:32:50 -0400 (Fri, 26 Sep 2014) $
 * </pre>
 *
...
class messengerFunctions
{
	...
	public function deleteTopics( $memberID, $ids, $rawSQL=NULL, $hardDelete=false )
	{
		...
		//-----------------------------------------
 		...
 		if( $hardDelete )
 		{
			...
			$class_attach->init();
			$class_attach->bulkRemoveAttachment( $idsForAttachments, 'attach_rel_id', TRUE );
 		}
 		else
 		{
			//-----------------------------------------
	...
	public function deleteMessages( $msgIDs=array(), $deletedByMemberID )
	{
		...
		$class_attach->type = 'msg';
		$class_attach->init();
		$class_attach->bulkRemoveAttachment( $idsToDelete, 'attach_rel_id', TRUE );
