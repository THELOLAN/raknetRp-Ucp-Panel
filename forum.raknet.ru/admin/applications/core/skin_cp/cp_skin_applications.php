 ...
 * Last Updated: $Date: 2013-05-28 10:00:25 -0400 (Tue, 28 May 2013) $
 * </pre>
 *
...
<div class='acp-box'>
	...
	<div class='acp-actionbar'>
		<a class='button' href='{$this->settings['base_url']}module=applications&section=enhancements&do=edit&service=enhancements_core_ipscdn&enable=1'>{$this->lang->words['cdn_activate']}</a>
	</div>
</div>
EOF;
...
$HTML .= $file->getFileContents( "http://www.invisionpower.com/clients/interface/ipscdnstats.php?key={$this->settings['ipb_reg_number']}" );
