 ...
 * Last Updated: $Date: 2013-02-14 19:17:38 -0500 (Thu, 14 Feb 2013) $
 * </pre>
 *
...
$form								= array();
$form['plugi_title']				= $this->registry->output->formInput('plugi_title', ( $this->request['plugi_title'] ) ? $this->request['plugi_title'] : $plug_data['class_title']);
$form['plugi_version']				= $this->registry->output->formInput('plugi_version', ( $this->request['plugi_version'] ) ? $this->request['plugi_version'] : $plug_data['pversion']);
$form['plugi_desc']					= $this->registry->output->formInput('plugi_desc', ( $this->request['plugi_desc'] ) ? $this->request['plugi_desc'] : htmlspecialchars($plug_data['class_desc'], ENT_QUOTES));
$form['plugi_author_url']			= $this->registry->output->formInput('plugi_author_url', ( $this->request['plugi_author_url'] ) ? $this->request['plugi_author_url'] : $plug_data['author_url']);
$form['plugi_author']				= $this->registry->output->formInput('plugi_author', ( $this->request['plugi_author'] ) ? $this->request['plugi_author'] : $plug_data['author']);
$form['plugi_file']					= $this->registry->output->formInput('plugi_file', ( $plug_data['my_class'] ? $plug_data['my_class'] : 'default' ));
$form['plugi_app']					= $this->registry->output->formDropdown( 'appPlugin', ( $this->request['plugi_app'] ) ? $this->request['plugi_app'] : $apps, $plug_data['app'] );
