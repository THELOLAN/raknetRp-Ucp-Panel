 ...
 * Last Updated: $Date: 2013-02-22 18:01:02 -0500 (Fri, 22 Feb 2013) $
 * </pre>
 *
...
/* This may be called from upgrader before langs are imported, so we'll hardcode fallbacks for these strings */
if( !$this->lang->words['d_dtitle'] )
{
	$this->lang->words	= array_merge( $this->lang->words, array(
