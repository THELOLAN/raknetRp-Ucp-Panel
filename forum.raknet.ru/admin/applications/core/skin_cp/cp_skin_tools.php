 ...
 * IP.Board v3.4.8
 * ACP Tools skin file
 * Last Updated: $Date: 2014-10-20 18:55:47 -0400 (Mon, 20 Oct 2014) $
 *
...
else
{
	...
	$expires = $this->lang->words['expires_prefix'] . ' ' . $expires;
}
...
<form action='{$this->settings['base_url']}{$this->form_code}' method='post'>
	...
	<div class='acp-box'>
		...
		<table class='ipsTable double_pad'>
			...
			<tr>
				<td class='field_title'>
					<strong class='title'>{$this->lang->words['sl_form_groups']}</strong>
				</td>
				<td class='field_field'>
					{$form['share_groups']}<br />
					<span class='desctext'>{$this->lang->words['sl_form_groups_desc']}</span>
				</td>
			</tr>
		</table>
		<div class='acp-actionbar'>
