 ...
 * Last Updated: $Date: 2013-01-17 15:51:17 -0500 (Thu, 17 Jan 2013) $
 * </pre>
 *
 ...
 * @return	string		HTML
 */
public function sqlToolResult( $columns, $rows ) {
$IPBHTML = "";
//--starthtml--//
 ...
 * @return	string		HTML
 */
public function sqlToolResultHeader( $columns ) {
$IPBHTML = "";
//--starthtml--//
...
/**
 * Show the footer for an SQL tool result
 *
 * @return	string		HTML
 */
public function sqlToolResultFooter() {
	$IPBHTML = "";
	//--starthtml--//
