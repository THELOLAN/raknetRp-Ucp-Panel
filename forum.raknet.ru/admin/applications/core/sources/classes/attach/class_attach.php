 ...
 * IP.Board v3.4.8
 * Attachments
 * Last Updated: $Date: 2014-08-29 15:04:48 -0400 (Fri, 29 Aug 2014) $
 * </pre>
 *
 * <code>
...
class class_attach
{
	 ...
	 */
	public function renderAttachments( $htmlArray, $rel_ids=array(), $skin_name='topic', $parse_og=true )
	{
		//-----------------------------------------
		// INIT
		//-----------------------------------------
	 ...
	 * @return	bool
	 */
	public function bulkRemoveAttachment( $remove_ids=array(), $id_type='attach_rel_id', $taskInitiated=FALSE )
	{
		/* INIT */
		$attachments = array();
		...
		/* Check Permissions */
		if( $this->plugin->canBulkRemove( $remove_ids ) === TRUE OR $taskInitiated )
		{
