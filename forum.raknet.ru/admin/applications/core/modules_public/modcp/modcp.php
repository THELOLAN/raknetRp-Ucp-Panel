 ...
 * $Author: bfarber $
 * @since		2/14/2011
 * $LastChangedDate: 2014-09-23 10:47:50 -0400 (Tue, 23 Sep 2014) $
 * @version		v3.4.8
 * $Revision: 12510 $
 */
...
{	
	...
	{
		/* Remove auth key */
		if( $this->request['auth_key'] )
		{
			$url = $this->settings['base_url'] . "app=core&amp;module=modcp&amp;do=editmember&amp;mid={$this->request['mid']}";

			if( $this->request['pf'] )
			{
				$url .= "&amp;pf={$this->request['pf']}";
			}
