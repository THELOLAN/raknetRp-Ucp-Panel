 ...
 * IP.Board v3.4.8
 * Global Search
 * Last Updated: $Date: 2013-10-28 09:05:10 -0400 (Mon, 28 Oct 2013) $
 * </pre>
 *
...
class public_core_search_search extends ipsCommand
{
	...
	protected function _setSortFilters()
	{
		...
		if( !is_string( $key ) )
		{
			$this->registry->getClass('output')->showError( 'invalid_search_key', 10312565 );
		}
	...
	protected function _returnSearchAppFilters()
	{
		...
		if( isset($this->request['search_app_filters']) AND $this->request['search_app_filters'] )
		{
			...
			{
				if( $app == $this->request['search_app'] AND is_array( $filters ) AND count($filters) )
				{
