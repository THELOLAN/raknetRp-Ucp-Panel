 ...
 * Last Updated: $Date: 2014-09-09 09:01:47 -0400 (Tue, 09 Sep 2014) $
 * </pre>
 *
...
class admin_core_system_security extends ipsCommand
{
	...
	public function securityOverview()
	{
		...
		if( strpos( strtolower( PHP_OS ), 'win' ) !== 0 )
		{
			...
			if ( ! is_file( IPS_CACHE_PATH . 'cache/.htaccess' ) or strpos( file_get_contents( IPS_CACHE_PATH . 'cache/.htaccess' ), 'Header set Content-Disposition attachment' ) === FALSE )
			{
				$content['bad'] .= $this->html->security_item_bad( $this->lang->words['s_phpcgi'],
