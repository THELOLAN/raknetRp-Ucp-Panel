...
class admin_core_templates_easylogo extends ipsCommand
{
	...
	public function complete()
	{
		...
		else
		{
			...
			/**
			 * @see http://community.invisionpower.com/resources/bugs.html/_/ip-board/https-and-easy-logo-changer-r37285
			 */
			$publicDir = str_replace( array( 'http:', 'https:' ), '', $this->settings['public_dir'] );
			
			$newlogo = "{$publicDir}style_images/{$this->request['skin']}_" . urlencode($FILE_NAME);
		}
