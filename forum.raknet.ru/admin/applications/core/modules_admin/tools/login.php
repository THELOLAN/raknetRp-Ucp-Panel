 ...
 * Last Updated: $Date: 2013-05-03 23:09:37 -0400 (Fri, 03 May 2013) $
 * </pre>
 *
...
class admin_core_tools_login extends ipsCommand
{
	...
	protected function _loginSaveConf()
	{
		...
		//-----------------------------------------
		// Specific check for IPS Connect
		//-----------------------------------------

		if( $login['login_folder_name'] == 'ipsconnect' )
		{
			if( $save['master_url'] == $this->settings['board_url'] . '/interface/ipsconnect/ipsconnect.php' )
			{
				ipsRegistry::getClass('output')->showError( $this->lang->words['l_slave_master_slave'] );
			}
		}
