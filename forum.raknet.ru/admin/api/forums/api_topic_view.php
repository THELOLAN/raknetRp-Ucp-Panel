 ...
 * $Author: AndyMillne $
 * @since		2.2.0
 * $LastChangedDate: 2013-03-21 17:38:09 -0400 (Thu, 21 Mar 2013) $
 * @version		v3.4.8
 * $Revision: 12109 $
 */
	...
	public function return_topic_list_data( $view_as_guest=false, $parse_display=false )
	{
		...
		if( count( $this->attach_pids ) )
		{
			...
			$this->DB->build( array( 'select'	=> '*',
									 'from'		=> 'attachments',
									 'where'	=> "attach_rel_module='post' AND attach_rel_id IN (" . IPSText::cleanPermString( implode( ",", $this->attach_pids ) ) . ")"
							 )      );
