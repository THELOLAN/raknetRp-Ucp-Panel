...
$IPBHTML .= <<<EOF
    <ul id='links'>
        ...
        <li><img src='{$this->registry->output->imageUrl}/link.gif' align='absmiddle' /> <a href='http://ipbmafia.ru'>Русскоязычный форум поддержки IPBmafia.Ru</a></li>
    </ul>
EOF;
...
<a href="http://ipbmafia.ru">Nulled for IPBMafia.ru</a>
				</div>
