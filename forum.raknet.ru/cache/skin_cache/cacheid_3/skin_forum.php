...
{
$count_a18702a40462d6e8ecb3d96c36ecfa02 = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_a18702a40462d6e8ecb3d96c36ecfa02]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_a18702a40462d6e8ecb3d96c36ecfa02]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_a18702a40462d6e8ecb3d96c36ecfa02]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_a18702a40462d6e8ecb3d96c36ecfa02]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_a18702a40462d6e8ecb3d96c36ecfa02]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_a18702a40462d6e8ecb3d96c36ecfa02]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_a18702a40462d6e8ecb3d96c36ecfa02]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_a18702a40462d6e8ecb3d96c36ecfa02]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_a18702a40462d6e8ecb3d96c36ecfa02]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_a18702a40462d6e8ecb3d96c36ecfa02]['inforum'] = $inforum;
}
...
" . ((is_array( $sub_forum_data ) AND count( $sub_forum_data )) ? ("
		<subforums>			
	".$this->__f__9e892fcd66afa4f7940c83afb174509c($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		</subforums>
") : ("")) . "
" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
		<announcements>			
	".$this->__f__856b98c01c1ce39eee5d66eedaa61550($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."		</announcements>
") : ("")) . "
		<topics>
" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("".$this->__f__557a270d2adf5a72b23e8ace6aead697($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."") : ("")) . "
		</topics>
...
function __f__a74158f6f9b4b8e41c3dc19a48da4310($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9e892fcd66afa4f7940c83afb174509c($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("					
			".$this->__f__a74158f6f9b4b8e41c3dc19a48da4310($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."		") : ("")) . "
...
function __f__856b98c01c1ce39eee5d66eedaa61550($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e75d245abeee1f01984decf85a3563a5($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__557a270d2adf5a72b23e8ace6aead697($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topic_data as $tid => $data )
	{
		...
		" . ((is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			<pagination>
			".$this->__f__e75d245abeee1f01984decf85a3563a5($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$tid,$data)."		</pagination>
		") : ("")) . "		
			</topic>
