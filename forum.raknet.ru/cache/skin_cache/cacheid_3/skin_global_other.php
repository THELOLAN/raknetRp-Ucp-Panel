...
{
$count_83e8d83699c6871d7b39712cace39c59 = is_array($this->functionData['notificationsList']) ? count($this->functionData['notificationsList']) : 0;
$this->functionData['notificationsList'][$count_83e8d83699c6871d7b39712cace39c59]['notifications'] = $notifications;
}
$IPBHTML .= "<template>popoverNotifications</template>
<notifications>
	".$this->__f__5d1c33806c8ca9709d785cc12e4f4ebc($notifications)."</notifications>";
return $IPBHTML;
}


function __f__5d1c33806c8ca9709d785cc12e4f4ebc($notifications)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5d9f8a47430b9c00086360128e50fb1c = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_5d9f8a47430b9c00086360128e50fb1c]['member'] = $member;
$this->functionData['repButtons'][$count_5d9f8a47430b9c00086360128e50fb1c]['data'] = $data;
}
