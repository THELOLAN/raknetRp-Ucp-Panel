...
{
$count_f3f1056aa98f3918ffacd5f879c33a95 = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_f3f1056aa98f3918ffacd5f879c33a95]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_f3f1056aa98f3918ffacd5f879c33a95]['error'] = $error;
$this->functionData['notificationsLog'][$count_f3f1056aa98f3918ffacd5f879c33a95]['pages'] = $pages;
}
$IPBHTML .= "<template>popoverNotifications</template>
<notifications>
	".$this->__f__af1b58e458ace2e52ad8e789e83dd252($notifications,$error,$pages)."</notifications>";
return $IPBHTML;
}


function __f__af1b58e458ace2e52ad8e789e83dd252($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
