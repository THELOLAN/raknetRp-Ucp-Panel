...
$IPBHTML = "";
$IPBHTML .= "<h1>
	<a href='{$this->settings['board_url']}' title='{$this->lang->words['go_home']}' rel=\"home\" accesskey='1'><img src=\"http://ucp.raknet.ru/templates/style/img/logo1.png\" alt=\"RakNet Role Play\" width=\"110\" height=\"25\"></a>
</h1>";
return $IPBHTML;
}
...
{
$count_169a7fd4316910c98996d2efda80d0af = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_169a7fd4316910c98996d2efda80d0af]['html'] = $html;
$this->functionData['globalTemplate'][$count_169a7fd4316910c98996d2efda80d0af]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_169a7fd4316910c98996d2efda80d0af]['css'] = $css;
$this->functionData['globalTemplate'][$count_169a7fd4316910c98996d2efda80d0af]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_169a7fd4316910c98996d2efda80d0af]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_169a7fd4316910c98996d2efda80d0af]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_169a7fd4316910c98996d2efda80d0af]['items'] = $items;
$this->functionData['globalTemplate'][$count_169a7fd4316910c98996d2efda80d0af]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_169a7fd4316910c98996d2efda80d0af]['stats'] = $stats;
}
$IPBHTML .= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">
	<html xml:lang=\"ru\" lang=\"ru\" xmlns=\"http://www.w3.org/1999/xhtml\"" . ((IPSLib::fbc_enabled() === TRUE || $this->settings['fbc_appid']) ? (" xmlns:fb=\"http://www.facebook.com/2008/fbml\"") : ("")) . ">
	<head>
...
<li id=''><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showuser={$this->memberData['member_id']}", "public",'' ), "{$this->memberData['members_seo_name']}", "" ) . "\" title='{$this->memberData['members_display_name']}'><span class='icon'></span>{$this->memberData['members_display_name']}</a></li>
				</ul>
			</div>
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__13af4dc0ec5504c9b78bdf0dea723d74($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
...
function __f__13af4dc0ec5504c9b78bdf0dea723d74($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ecbbefe09948385bcd9971ab5b141fe7 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_ecbbefe09948385bcd9971ab5b141fe7]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__3b5a1dd31f4f77f7eee03153001aec1e($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__96dae82a99fc853cd67f6160bcd59d1c($css)."") : ("")) . "";
return $IPBHTML;
}


function __f__3b5a1dd31f4f77f7eee03153001aec1e($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__96dae82a99fc853cd67f6160bcd59d1c($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f3f82747e2a0eaf25b5212046a3b9737 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_f3f82747e2a0eaf25b5212046a3b9737]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__2a0eac3298a97c295b15999f47b70e6d($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__49e7b465f7c0e91d6c7fa025b5052e07($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2a0eac3298a97c295b15999f47b70e6d($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__49e7b465f7c0e91d6c7fa025b5052e07($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_9aed4d83c44595b6b731de441bcabb42 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_9aed4d83c44595b6b731de441bcabb42]['jsModules'] = $jsModules;
}
...
{
$count_6785e1aa90fbc45697e523fbabef1c02 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_6785e1aa90fbc45697e523fbabef1c02]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__6a67d633bd55a8c8dead78e4883e8169($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__943d2ff5fef6360b8166ea380c095955($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6a67d633bd55a8c8dead78e4883e8169($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__943d2ff5fef6360b8166ea380c095955($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_a550ae035da4f1cb47943667c44bff15 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__e3d2b8ecda3b956dbde77d18215e486c()."<script type='text/javascript'>
	var isRTL	= false;
	var rtlIe	= '';
	var rtlFull	= '';
</script>
...
function __f__e3d2b8ecda3b956dbde77d18215e486c()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d70a056203c18211f9e322dd643c4950 = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_d70a056203c18211f9e322dd643c4950]['data'] = $data;
}
...
{
$count_cb4c5322876094495b0912c782840ff5 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_cb4c5322876094495b0912c782840ff5]['work'] = $work;
$this->functionData['paginationTemplate'][$count_cb4c5322876094495b0912c782840ff5]['data'] = $data;
}
...
{
$count_dd74b3096ad589b26ab44f95ae8f15a4 = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_dd74b3096ad589b26ab44f95ae8f15a4]['member'] = $member;
}
...
{
$count_792622a5e2a1af6b83cc642c1a0797ff = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_792622a5e2a1af6b83cc642c1a0797ff]['author'] = $author;
$this->functionData['userInfoPane'][$count_792622a5e2a1af6b83cc642c1a0797ff]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_792622a5e2a1af6b83cc642c1a0797ff]['options'] = $options;
}
$IPBHTML .= "<ul class='user_details'>
	...
	<ul class='user_fields'>
		...
		" . (($author['custom_fields'] != "") ? ("
			".$this->__f__2afa421a3ba17c0c792c1506cf272a70($author,$contentid,$options)."		") : ("")) . "
	</ul>
...
function __f__1003e144f120d895af27c4e295e924da($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2afa421a3ba17c0c792c1506cf272a70($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__1003e144f120d895af27c4e295e924da($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_18982e59c6de5adee816ef7e14d9ba21 = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_18982e59c6de5adee816ef7e14d9ba21]['member'] = $member;
}
...
{
$count_4280d4239aa69bd57caa9713cce5e579 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_4280d4239aa69bd57caa9713cce5e579]['warning'] = $warning;
$this->functionData['warnDetails'][$count_4280d4239aa69bd57caa9713cce5e579]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__e88be76d47273534534da819b8dd499d($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__e88be76d47273534534da819b8dd499d($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
