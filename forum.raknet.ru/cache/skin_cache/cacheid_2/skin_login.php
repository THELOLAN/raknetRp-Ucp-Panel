...
{
$count_b9f5a821f1990321be72da756b306910 = is_array($this->functionData['showLogInForm']) ? count($this->functionData['showLogInForm']) : 0;
$this->functionData['showLogInForm'][$count_b9f5a821f1990321be72da756b306910]['message'] = $message;
$this->functionData['showLogInForm'][$count_b9f5a821f1990321be72da756b306910]['referer'] = $referer;
$this->functionData['showLogInForm'][$count_b9f5a821f1990321be72da756b306910]['extra_form'] = $extra_form;
$this->functionData['showLogInForm'][$count_b9f5a821f1990321be72da756b306910]['login_methods'] = $login_methods;
}
