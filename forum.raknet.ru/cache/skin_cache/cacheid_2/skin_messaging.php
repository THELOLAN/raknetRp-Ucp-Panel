...
{
$count_4e3a81c10016b9563830b7cc319467f7 = is_array($this->functionData['messengerDisabled']) ? count($this->functionData['messengerDisabled']) : 0;
}
...
{
$count_3feb1a7c9190e626f1abfe8320567cc7 = is_array($this->functionData['messengerTemplate']) ? count($this->functionData['messengerTemplate']) : 0;
$this->functionData['messengerTemplate'][$count_3feb1a7c9190e626f1abfe8320567cc7]['html'] = $html;
$this->functionData['messengerTemplate'][$count_3feb1a7c9190e626f1abfe8320567cc7]['jumpmenu'] = $jumpmenu;
$this->functionData['messengerTemplate'][$count_3feb1a7c9190e626f1abfe8320567cc7]['dirData'] = $dirData;
$this->functionData['messengerTemplate'][$count_3feb1a7c9190e626f1abfe8320567cc7]['totalData'] = $totalData;
$this->functionData['messengerTemplate'][$count_3feb1a7c9190e626f1abfe8320567cc7]['topicParticipants'] = $topicParticipants;
$this->functionData['messengerTemplate'][$count_3feb1a7c9190e626f1abfe8320567cc7]['inlineError'] = $inlineError;
$this->functionData['messengerTemplate'][$count_3feb1a7c9190e626f1abfe8320567cc7]['deletedTopic'] = $deletedTopic;
}
$IPBHTML .= "<div class='master_list'>
	...
	" . ((is_array( $topicParticipants ) and count( $topicParticipants )) ? ("
		...
		".$this->__f__507f48759bc4e04f7351d397c818412e($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."	") : ("")) . "				
	...
	" . (($this->settings['_hideFolders'] != 1) ? ("<h3>{$this->lang->words['folders']} " . (($this->memberData['g_max_messages'] > 0) ? ("<span class='subtext'>{$totalData['full_percent']}% {$this->lang->words['full']}</span>") : ("")) . "</h3>
		...
		" . ((count($dirData)) ? ("
			".$this->__f__8751d65c0647026772e98b02cfb17234($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."		") : ("")) . "") : ("")) . "
</div>";
return $IPBHTML;
}


function __f__507f48759bc4e04f7351d397c818412e($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8751d65c0647026772e98b02cfb17234($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e752c79ebc177eaadf2a3d3fe2292eec = is_array($this->functionData['sendNewPersonalTopicForm']) ? count($this->functionData['sendNewPersonalTopicForm']) : 0;
$this->functionData['sendNewPersonalTopicForm'][$count_e752c79ebc177eaadf2a3d3fe2292eec]['displayData'] = $displayData;
}
...
<form id='msgForm' class='ipsForm_vertical' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=messaging&amp;section=send&amp;do=send", "publicWithApp",'' ), "", "" ) . "\" method=\"post\" enctype='multipart/form-data'>
	" . (($displayData['errors']) ? ("
		<div class='message error'>
			...
			".$this->__f__8a49b020ca79e6b366c1e5f907e71416($displayData)."			{$this->lang->words['pme_none_sent']}
		</div>
	") : ("")) . "
...
function __f__8a49b020ca79e6b366c1e5f907e71416($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5347c450b0444896f2db8d5e163a844f = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_5347c450b0444896f2db8d5e163a844f]['displayData'] = $displayData;
}
$IPBHTML .= "" . (($this->settings['_hideFolders'] = 1) ? ("") : ("")) . "
...
" . (($displayData['errors']) ? ("
	<div class='message error'>
		<strong>{$this->lang->words['err_errors']}</strong><br />
		".$this->__f__62059651af2cfba23e0e0a4fe88730e9($displayData)."		{$this->lang->words['pme_none_sent']}
	</div>
") : ("")) . "
" . (($displayData['type'] == 'reply') ? ("
...
function __f__62059651af2cfba23e0e0a4fe88730e9($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $displayData['errors'] as $_error )
...
{
$count_6da3b1a3a7c9582dbf6d1953e697072c = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_6da3b1a3a7c9582dbf6d1953e697072c]['topic'] = $topic;
$this->functionData['showConversation'][$count_6da3b1a3a7c9582dbf6d1953e697072c]['replies'] = $replies;
$this->functionData['showConversation'][$count_6da3b1a3a7c9582dbf6d1953e697072c]['members'] = $members;
$this->functionData['showConversation'][$count_6da3b1a3a7c9582dbf6d1953e697072c]['jump'] = $jump;
}
$IPBHTML .= "<div class='controls'>
	...
	{$topic['_pages']}
</div>".$this->__f__b713565b418464189a7744605bf1e988($topic,$replies,$members,$jump)."<div class='controls'>
	<div class='buttons'>
...
function __f__b713565b418464189a7744605bf1e988($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_23aacb47c738e0a63f8aec4c9242400d = is_array($this->functionData['showConversationForArchive']) ? count($this->functionData['showConversationForArchive']) : 0;
$this->functionData['showConversationForArchive'][$count_23aacb47c738e0a63f8aec4c9242400d]['topic'] = $topic;
$this->functionData['showConversationForArchive'][$count_23aacb47c738e0a63f8aec4c9242400d]['replies'] = $replies;
$this->functionData['showConversationForArchive'][$count_23aacb47c738e0a63f8aec4c9242400d]['members'] = $members;
}
...
$IPBHTML .= "<html>
	...
	<body>
		...
		<br />
		<br />
		".$this->__f__c907ca7d752101316ad034c72a523166($topic,$replies,$members)."	</body>
</html>";
return $IPBHTML;
}


function __f__c907ca7d752101316ad034c72a523166($topic, $replies, $members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $replies as $msg_id => $msg )
...
{
$count_8d7e38ba1cbb593d4937674dca81ff42 = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_8d7e38ba1cbb593d4937674dca81ff42]['messages'] = $messages;
$this->functionData['showFolder'][$count_8d7e38ba1cbb593d4937674dca81ff42]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_8d7e38ba1cbb593d4937674dca81ff42]['pages'] = $pages;
$this->functionData['showFolder'][$count_8d7e38ba1cbb593d4937674dca81ff42]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_8d7e38ba1cbb593d4937674dca81ff42]['jumpFolderHTML'] = $jumpFolderHTML;
}
...
" . ((count( $messages )) ? ("
		".$this->__f__a681a7476179272b1b87a16ce79bacfd($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."") : ("
...
function __f__a681a7476179272b1b87a16ce79bacfd($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3b6089d64a6d635f08f4b7d795d40351 = is_array($this->functionData['showSearchResults']) ? count($this->functionData['showSearchResults']) : 0;
$this->functionData['showSearchResults'][$count_3b6089d64a6d635f08f4b7d795d40351]['messages'] = $messages;
$this->functionData['showSearchResults'][$count_3b6089d64a6d635f08f4b7d795d40351]['pages'] = $pages;
$this->functionData['showSearchResults'][$count_3b6089d64a6d635f08f4b7d795d40351]['error'] = $error;
}
...
<div id='message_list'>
		<table class='ipb_table' id='message_table'>
			...
			" . ((count( $messages )) ? ("
								".$this->__f__faa632d49383adb3da28dd6c9c8c23a7($messages,$pages,$error)."			") : ("
				<tr>
...
function __f__faa632d49383adb3da28dd6c9c8c23a7($messages, $pages, $error)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $messages as $id => $msg )
