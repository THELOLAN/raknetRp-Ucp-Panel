...
{
$count_a886fa940863359feb02e458e313fba8 = is_array($this->functionData['ajaxPopUpNoPermission']) ? count($this->functionData['ajaxPopUpNoPermission']) : 0;
$this->functionData['ajaxPopUpNoPermission'][$count_a886fa940863359feb02e458e313fba8]['msg'] = $msg;
}
...
{
$count_2fa9ec229f79135cf76f6f8189a68641 = is_array($this->functionData['displayBoardOffline']) ? count($this->functionData['displayBoardOffline']) : 0;
$this->functionData['displayBoardOffline'][$count_2fa9ec229f79135cf76f6f8189a68641]['message'] = $message;
}
...
{
$count_1fb97044ff1edc8f27ad6684b263ff76 = is_array($this->functionData['displayPopUpWindow']) ? count($this->functionData['displayPopUpWindow']) : 0;
$this->functionData['displayPopUpWindow'][$count_1fb97044ff1edc8f27ad6684b263ff76]['documentHeadItems'] = $documentHeadItems;
$this->functionData['displayPopUpWindow'][$count_1fb97044ff1edc8f27ad6684b263ff76]['css'] = $css;
$this->functionData['displayPopUpWindow'][$count_1fb97044ff1edc8f27ad6684b263ff76]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['displayPopUpWindow'][$count_1fb97044ff1edc8f27ad6684b263ff76]['title'] = $title;
$this->functionData['displayPopUpWindow'][$count_1fb97044ff1edc8f27ad6684b263ff76]['output'] = $output;
}
...
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\"> 
	<head>
		...
		" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
			".$this->__f__0f7b950e7bd6ef8c31c3c0ec1825b5dc($documentHeadItems,$css,$jsLoaderItems,$title,$output)."			" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
		...
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__134acdf9eba7325eaa76a5b554180320($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<!--[if lte IE 7]>
		...
		" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
			".$this->__f__e5e07bce62d377a94372b966868da71a($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__4b4ba9b4e3d45f6872335a7915da9dd6($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
...
function __f__0f7b950e7bd6ef8c31c3c0ec1825b5dc($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__134acdf9eba7325eaa76a5b554180320($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e5e07bce62d377a94372b966868da71a($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e29a624de02e6ce16b19ce3f4757947d($documentHeadItems, $css, $jsLoaderItems, $title="", $output="",$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4b4ba9b4e3d45f6872335a7915da9dd6($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__e29a624de02e6ce16b19ce3f4757947d($documentHeadItems,$css,$jsLoaderItems,$title,$output,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_7c2c8487dbf3440baf8a2fac260990dd = is_array($this->functionData['Error']) ? count($this->functionData['Error']) : 0;
$this->functionData['Error'][$count_7c2c8487dbf3440baf8a2fac260990dd]['message'] = $message;
$this->functionData['Error'][$count_7c2c8487dbf3440baf8a2fac260990dd]['code'] = $code;
$this->functionData['Error'][$count_7c2c8487dbf3440baf8a2fac260990dd]['ad_email_one'] = $ad_email_one;
$this->functionData['Error'][$count_7c2c8487dbf3440baf8a2fac260990dd]['ad_email_two'] = $ad_email_two;
$this->functionData['Error'][$count_7c2c8487dbf3440baf8a2fac260990dd]['title'] = $title;
}
...
{
$count_c0db5f01c1cd43b0722ad23a7da5059c = is_array($this->functionData['generateTopicIcon']) ? count($this->functionData['generateTopicIcon']) : 0;
$this->functionData['generateTopicIcon'][$count_c0db5f01c1cd43b0722ad23a7da5059c]['imgArray'] = $imgArray;
$this->functionData['generateTopicIcon'][$count_c0db5f01c1cd43b0722ad23a7da5059c]['unreadUrl'] = $unreadUrl;
}
...
{
$count_319929309bac77f00cba335860050ff5 = is_array($this->functionData['globalTemplateMinimal']) ? count($this->functionData['globalTemplateMinimal']) : 0;
$this->functionData['globalTemplateMinimal'][$count_319929309bac77f00cba335860050ff5]['html'] = $html;
$this->functionData['globalTemplateMinimal'][$count_319929309bac77f00cba335860050ff5]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplateMinimal'][$count_319929309bac77f00cba335860050ff5]['css'] = $css;
$this->functionData['globalTemplateMinimal'][$count_319929309bac77f00cba335860050ff5]['jsModules'] = $jsModules;
$this->functionData['globalTemplateMinimal'][$count_319929309bac77f00cba335860050ff5]['metaTags'] = $metaTags;
$this->functionData['globalTemplateMinimal'][$count_319929309bac77f00cba335860050ff5]['header_items'] = $header_items;
$this->functionData['globalTemplateMinimal'][$count_319929309bac77f00cba335860050ff5]['items'] = $items;
$this->functionData['globalTemplateMinimal'][$count_319929309bac77f00cba335860050ff5]['footer_items'] = $footer_items;
$this->functionData['globalTemplateMinimal'][$count_319929309bac77f00cba335860050ff5]['stats'] = $stats;
}
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__96ffb5aff8527321eb10dcac00b86b4a($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
...
function __f__96ffb5aff8527321eb10dcac00b86b4a($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9887cdd3d77b2db928ef3ddf9fc7e5a3 = is_array($this->functionData['redirectTemplate']) ? count($this->functionData['redirectTemplate']) : 0;
$this->functionData['redirectTemplate'][$count_9887cdd3d77b2db928ef3ddf9fc7e5a3]['documentHeadItems'] = $documentHeadItems;
$this->functionData['redirectTemplate'][$count_9887cdd3d77b2db928ef3ddf9fc7e5a3]['css'] = $css;
$this->functionData['redirectTemplate'][$count_9887cdd3d77b2db928ef3ddf9fc7e5a3]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['redirectTemplate'][$count_9887cdd3d77b2db928ef3ddf9fc7e5a3]['text'] = $text;
$this->functionData['redirectTemplate'][$count_9887cdd3d77b2db928ef3ddf9fc7e5a3]['url'] = $url;
$this->functionData['redirectTemplate'][$count_9887cdd3d77b2db928ef3ddf9fc7e5a3]['full'] = $full;
}
$IPBHTML .= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"> 
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\"> 
	<head>
		...
		<link rel=\"shortcut icon\" href='" . (($this->registry->output->isHTTPS) ? ("{$this->settings['board_url_https']}") : ("{$this->settings['board_url']}")) . "/favicon.ico' />
		" . ((is_array( $css['import'] )) ? ("
			".$this->__f__cd1da09e6480917b8fc6051e7c826524($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__e959ad7ff3489cdcf1ec514662fe28db($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--[if lte IE 7]>
			<link rel=\"stylesheet\" type=\"text/css\" title='Main' media=\"screen\" href=\"{$this->settings['public_dir']}style_css/{$this->registry->output->skin['_csscacheid']}/ipb_ie.css\" />
		<![endif]-->
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__6bc17916a6011e6d76501e463d28d753($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--/CSS-->
		<script type='text/javascript'>
		//<![CDATA[
...
function __f__cd1da09e6480917b8fc6051e7c826524($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['import'] as $data )
...
function __f__e959ad7ff3489cdcf1ec514662fe28db($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['inline'] as $data )
...
function __f__0a362acbb0b7ed0f1715f861110af648($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems[ $type ] as $idx => $data )
...
function __f__6bc17916a6011e6d76501e463d28d753($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__0a362acbb0b7ed0f1715f861110af648($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_899d9e1fa16a6d3bd99cdb629f699ab1 = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_899d9e1fa16a6d3bd99cdb629f699ab1]['member'] = $member;
$this->functionData['repButtons'][$count_899d9e1fa16a6d3bd99cdb629f699ab1]['data'] = $data;
}
...
<div class='likepop fixed_inner'>
	<ul class='ipsList_withminiphoto'>
		".$this->__f__389a3b22dcc9447cd20510402d4a553a($data,$relId)."	</ul>
</div>";
return $IPBHTML;
}


function __f__389a3b22dcc9447cd20510402d4a553a($data, $relId)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML .= "<div>
	...
	<div class='ipsPad' style='min-height: 60px'>
		...
		") : ("".$this->__f__bdcbb130f4dab6f433069adbe4717f58($reps)."		")) . "
	</div>
</div>";
return $IPBHTML;
}
...
function __f__bdcbb130f4dab6f433069adbe4717f58($reps)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reps as $r )
...
{
$count_8269fb2066fe9630867196e41b5e1710 = is_array($this->functionData['tagCloud']) ? count($this->functionData['tagCloud']) : 0;
$this->functionData['tagCloud'][$count_8269fb2066fe9630867196e41b5e1710]['tags'] = $tags;
}
$IPBHTML .= "<h3 class='maintitle'>{$this->lang->words['mob_tags']}</h3>
<div class='ipsBox'>
	<div class='ipsBox_container ipsPad'>
		<ul class='ipsList_inline'>
		".$this->__f__fbd3aa564545dbb77b644508a473c564($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__fbd3aa564545dbb77b644508a473c564($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4537462e3292e97ab0f2c18de3688d89 = is_array($this->functionData['tagEntry']) ? count($this->functionData['tagEntry']) : 0;
$this->functionData['tagEntry'][$count_4537462e3292e97ab0f2c18de3688d89]['tag'] = $tag;
$this->functionData['tagEntry'][$count_4537462e3292e97ab0f2c18de3688d89]['noClass'] = $noClass;
$this->functionData['tagEntry'][$count_4537462e3292e97ab0f2c18de3688d89]['app'] = $app;
$this->functionData['tagEntry'][$count_4537462e3292e97ab0f2c18de3688d89]['section'] = $section;
}
...
{
$count_af1fe3c004d9574d4cacc5d7b31a1692 = is_array($this->functionData['tagPrefix']) ? count($this->functionData['tagPrefix']) : 0;
$this->functionData['tagPrefix'][$count_af1fe3c004d9574d4cacc5d7b31a1692]['tag'] = $tag;
$this->functionData['tagPrefix'][$count_af1fe3c004d9574d4cacc5d7b31a1692]['app'] = $app;
$this->functionData['tagPrefix'][$count_af1fe3c004d9574d4cacc5d7b31a1692]['section'] = $section;
}
			...
			<div class='ipsTagBox_editor'>
				<span id='{$options['fieldId']}_addwrap'>
					" . ((!$options['isOpenSystem']) ? ("<select id='{$options['fieldId']}_tag_select' class='input_select'>
							" . ((!empty( $options['predefinedTags'] )) ? ("".$this->__f__36cb9f948ed827fae850702f730a0e1e($tags,$options,$where)."							") : ("")) . "
						</select>") : ("
...
function __f__36cb9f948ed827fae850702f730a0e1e($tags, $options, $where)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
