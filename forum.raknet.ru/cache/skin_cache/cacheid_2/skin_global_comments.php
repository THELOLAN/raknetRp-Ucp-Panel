...
{
$count_f5eccd2d5cf3821064b28908af145938 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_f5eccd2d5cf3821064b28908af145938]['comments'] = $comments;
$this->functionData['commentsList'][$count_f5eccd2d5cf3821064b28908af145938]['settings'] = $settings;
$this->functionData['commentsList'][$count_f5eccd2d5cf3821064b28908af145938]['pages'] = $pages;
$this->functionData['commentsList'][$count_f5eccd2d5cf3821064b28908af145938]['parent'] = $parent;
$this->functionData['commentsList'][$count_f5eccd2d5cf3821064b28908af145938]['preReply'] = $preReply;
}
...
<div class='comment_wrap' id='comment_wrap'>
	".$this->__f__36e1245c9eac9c8016c8698d87abde04($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($parent['_canComment']) ? ("
...
function __f__36e1245c9eac9c8016c8698d87abde04($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1c352b814f772132e6c0576d08e104cd = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_1c352b814f772132e6c0576d08e104cd]['comment'] = $comment;
$this->functionData['form'][$count_1c352b814f772132e6c0576d08e104cd]['parent'] = $parent;
$this->functionData['form'][$count_1c352b814f772132e6c0576d08e104cd]['editor'] = $editor;
$this->functionData['form'][$count_1c352b814f772132e6c0576d08e104cd]['settings'] = $settings;
$this->functionData['form'][$count_1c352b814f772132e6c0576d08e104cd]['errors'] = $errors;
$this->functionData['form'][$count_1c352b814f772132e6c0576d08e104cd]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
