...
{
$count_8a3d1133a879d9482e9ec204561aea50 = is_array($this->functionData['group_strip']) ? count($this->functionData['group_strip']) : 0;
$this->functionData['group_strip'][$count_8a3d1133a879d9482e9ec204561aea50]['group'] = $group;
$this->functionData['group_strip'][$count_8a3d1133a879d9482e9ec204561aea50]['members'] = $members;
$this->functionData['group_strip'][$count_8a3d1133a879d9482e9ec204561aea50]['pagination'] = $pagination;
}
...
<table class='ipb_table ipsMemberList'>
	...
	" . ((count($members) AND is_array($members)) ? ("
				".$this->__f__27b0b097841b1410e06d9e8b6924d464($group,$members,$pagination)."	") : ("")) . "
</table>
" . (($pagination) ? ("
	<div class='topic_controls'>{$pagination}</div>
") : ("")) . "
...
function __f__6617f22d3732ada6c11630a42ae6ff65($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6a604ff5279dec7ac6a7e27978645c29($group="", $members=array(), $pagination='',$info='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $info['forums'] as $id => $name )
...
function __f__27b0b097841b1410e06d9e8b6924d464($group="", $members=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<tr class='" .  IPSLib::next( $this->registry->templateStriping["staff"] ) . "'>
				...
				<td class='altrow short'>
					" . ((is_array($info['forums'])) ? ("" . ((empty( $info['forums'] )) ? ("
							--
						") : ("" . ((count( $info['forums'] ) == 1) ? ("
								".$this->__f__6617f22d3732ada6c11630a42ae6ff65($group,$members,$pagination,$info)."							") : ("
								...
								".$this->__f__6a604ff5279dec7ac6a7e27978645c29($group,$members,$pagination,$info)."								</ul>
...
{
$count_ab9a55aded055cce47796a2c4ecf59b6 = is_array($this->functionData['top_posters']) ? count($this->functionData['top_posters']) : 0;
$this->functionData['top_posters'][$count_ab9a55aded055cce47796a2c4ecf59b6]['rows'] = $rows;
}
...
<table class='ipb_table ipsMemberList'>
	...
	") : ("
				".$this->__f__653498b352982f42e3ff518a3f71161a($rows)."	")) . "
</table>";
return $IPBHTML;
}


function __f__653498b352982f42e3ff518a3f71161a($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d1bb7b421a9385579bccf3ea04f7fff2 = is_array($this->functionData['whoPosted']) ? count($this->functionData['whoPosted']) : 0;
$this->functionData['whoPosted'][$count_d1bb7b421a9385579bccf3ea04f7fff2]['tid'] = $tid;
$this->functionData['whoPosted'][$count_d1bb7b421a9385579bccf3ea04f7fff2]['title'] = $title;
$this->functionData['whoPosted'][$count_d1bb7b421a9385579bccf3ea04f7fff2]['rows'] = $rows;
}
...
<div class='fixed_inner'>
	<table class='ipb_table'>
		...
		" . ((count($rows) AND is_array($rows)) ? ("
						".$this->__f__e2f438fcffe490b22df7a29ec61cc270($tid,$title,$rows)."		") : ("")) . "
	</table>
</div>";
return $IPBHTML;
}
...
function __f__e2f438fcffe490b22df7a29ec61cc270($tid=0, $title="", $rows=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
