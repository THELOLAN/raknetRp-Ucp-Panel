...
{
$count_9669c082ce99444bc864ac8d42649dfa = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_9669c082ce99444bc864ac8d42649dfa]['title'] = $title;
$this->functionData['forward_form'][$count_9669c082ce99444bc864ac8d42649dfa]['text'] = $text;
$this->functionData['forward_form'][$count_9669c082ce99444bc864ac8d42649dfa]['lang'] = $lang;
$this->functionData['forward_form'][$count_9669c082ce99444bc864ac8d42649dfa]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_9669c082ce99444bc864ac8d42649dfa]['msg'] = $msg;
}
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__173b4d8340877a4765ea3e0f15daa817($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__173b4d8340877a4765ea3e0f15daa817($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
