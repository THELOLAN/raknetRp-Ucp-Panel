...
{
$count_e9c84de8a8bd11b27bc43830842962d6 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_e9c84de8a8bd11b27bc43830842962d6]['data'] = $data;
}
...
{
$count_08002a5076a735a0d1c48be53d131a48 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_08002a5076a735a0d1c48be53d131a48]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_08002a5076a735a0d1c48be53d131a48]['form'] = $form;
}
...
{
$count_68b45005cfa0bab35b248a7f07ca1d85 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_68b45005cfa0bab35b248a7f07ca1d85]['data'] = $data;
}
...
{
$count_4440c28f705c556797f87956cba33362 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_4440c28f705c556797f87956cba33362]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__5d9c76eb517f6dc5b89b649eccf26c79($posts)."") : ("")) . "
<p class='submit'>
...
function __f__5d9c76eb517f6dc5b89b649eccf26c79($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b61007f99ae1b5668cd6a56f95aca37f = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_b61007f99ae1b5668cd6a56f95aca37f]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_b61007f99ae1b5668cd6a56f95aca37f]['type'] = $type;
$this->functionData['uploadForm'][$count_b61007f99ae1b5668cd6a56f95aca37f]['stats'] = $stats;
$this->functionData['uploadForm'][$count_b61007f99ae1b5668cd6a56f95aca37f]['id'] = $id;
$this->functionData['uploadForm'][$count_b61007f99ae1b5668cd6a56f95aca37f]['forum_id'] = $forum_id;
}
