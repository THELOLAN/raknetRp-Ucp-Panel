...
{
$count_e26f56fcfdbf5234a02c3bacffb50bf5 = is_array($this->functionData['asForumPosts']) ? count($this->functionData['asForumPosts']) : 0;
$this->functionData['asForumPosts'][$count_e26f56fcfdbf5234a02c3bacffb50bf5]['data'] = $data;
}
$IPBHTML .= "<div class='row'>
	...
	{$this->lang->words['in']}
	".$this->__f__fa952d9f7192f64d5379f6f0f5975025($data)."	
	" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
		<span class='mini_pagination'>
			".$this->__f__2b85d11bc4ba27ccd7b91eb82f49bcf6($data)."		</span>
	") : ("")) . "
	<br />
...
function __f__fa952d9f7192f64d5379f6f0f5975025($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2b85d11bc4ba27ccd7b91eb82f49bcf6($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8aa994f237a0ddafaa55f27738c0697b = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_8aa994f237a0ddafaa55f27738c0697b]['data'] = $data;
}
$IPBHTML .= "<div class='row touch-row " . ((!empty( $data['_unreadUrl'] )) ? ("unread") : ("")) . "' id=\"sr-{$data['type_id_2']}\">
	...
	<div class='rowContent'>
		...
		") : ("")) . "
		<div>
			" . ucfirst($this->lang->words['in']) . "".$this->__f__e289359bf7270d2b31b629358bc4f6cc($data)."		</div>
...
function __f__e289359bf7270d2b31b629358bc4f6cc($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['_forum_trail'] as $i => $f )
...
{
$count_bfef6fc5e63d743ca4fc8493bca44be0 = is_array($this->functionData['followData']) ? count($this->functionData['followData']) : 0;
$this->functionData['followData'][$count_bfef6fc5e63d743ca4fc8493bca44be0]['followData'] = $followData;
}
...
{
$count_cb3c37c6402816957f13215d49d20ff7 = is_array($this->functionData['followedContentForumsWrapper']) ? count($this->functionData['followedContentForumsWrapper']) : 0;
$this->functionData['followedContentForumsWrapper'][$count_cb3c37c6402816957f13215d49d20ff7]['results'] = $results;
}
$IPBHTML .= "" . ((count($results)) ? ("".$this->__f__f7b304cae45a330ec66b88bb69d45290($results)."") : ("")) . "";
return $IPBHTML;
}


function __f__f7b304cae45a330ec66b88bb69d45290($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_10be996965abdaa7bc1d515815cf1775 = is_array($this->functionData['followedContentForumsWrapperForums']) ? count($this->functionData['followedContentForumsWrapperForums']) : 0;
$this->functionData['followedContentForumsWrapperForums'][$count_10be996965abdaa7bc1d515815cf1775]['results'] = $results;
}
...
<div class='master_list'>
	".$this->__f__73a145732a6083c585f953ab8f2ec67a($results)."</div>";
return $IPBHTML;
}


function __f__73a145732a6083c585f953ab8f2ec67a($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9dbe6c44a637b16a05da639b77250858 = is_array($this->functionData['followedContentView']) ? count($this->functionData['followedContentView']) : 0;
$this->functionData['followedContentView'][$count_9dbe6c44a637b16a05da639b77250858]['results'] = $results;
$this->functionData['followedContentView'][$count_9dbe6c44a637b16a05da639b77250858]['pagination'] = $pagination;
$this->functionData['followedContentView'][$count_9dbe6c44a637b16a05da639b77250858]['total'] = $total;
$this->functionData['followedContentView'][$count_9dbe6c44a637b16a05da639b77250858]['error'] = $error;
$this->functionData['followedContentView'][$count_9dbe6c44a637b16a05da639b77250858]['contentTypes'] = $contentTypes;
}
$IPBHTML .= "" . (($pagination) ? ("
<div class='controls'>
...
<div class='master_list'>
	...
	<div class='ipsPad'>
		...
		".$this->__f__769f9c6790a14fb6cb392c3fd35e3fc1($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>
<div class='master_list'>
	...
	<div class='ipsPad'>
		<ul>
			".$this->__f__32136937010a4e83a548cdc5a8fe2494($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__769f9c6790a14fb6cb392c3fd35e3fc1($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__32136937010a4e83a548cdc5a8fe2494($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_88b949c469c59e96b2c5cdefe2d381ef = is_array($this->functionData['forumAdvancedSearchFilters']) ? count($this->functionData['forumAdvancedSearchFilters']) : 0;
$this->functionData['forumAdvancedSearchFilters'][$count_88b949c469c59e96b2c5cdefe2d381ef]['forums'] = $forums;
$this->functionData['forumAdvancedSearchFilters'][$count_88b949c469c59e96b2c5cdefe2d381ef]['archivedPostCount'] = $archivedPostCount;
$this->functionData['forumAdvancedSearchFilters'][$count_88b949c469c59e96b2c5cdefe2d381ef]['topic'] = $topic;
}
...
{
$count_4809d29f970b6a6461c6032abbbd179b = is_array($this->functionData['helpSearchResult']) ? count($this->functionData['helpSearchResult']) : 0;
$this->functionData['helpSearchResult'][$count_4809d29f970b6a6461c6032abbbd179b]['r'] = $r;
$this->functionData['helpSearchResult'][$count_4809d29f970b6a6461c6032abbbd179b]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_8744b5b06cfaf8bedb0df1ff7b80973a = is_array($this->functionData['memberCommentsSearchResult']) ? count($this->functionData['memberCommentsSearchResult']) : 0;
$this->functionData['memberCommentsSearchResult'][$count_8744b5b06cfaf8bedb0df1ff7b80973a]['r'] = $r;
$this->functionData['memberCommentsSearchResult'][$count_8744b5b06cfaf8bedb0df1ff7b80973a]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_f23d9d3ab432fad375281464cce94609 = is_array($this->functionData['newContentView']) ? count($this->functionData['newContentView']) : 0;
$this->functionData['newContentView'][$count_f23d9d3ab432fad375281464cce94609]['results'] = $results;
$this->functionData['newContentView'][$count_f23d9d3ab432fad375281464cce94609]['pagination'] = $pagination;
$this->functionData['newContentView'][$count_f23d9d3ab432fad375281464cce94609]['total'] = $total;
$this->functionData['newContentView'][$count_f23d9d3ab432fad375281464cce94609]['sortDropDown'] = $sortDropDown;
$this->functionData['newContentView'][$count_f23d9d3ab432fad375281464cce94609]['sortIn'] = $sortIn;
$this->functionData['newContentView'][$count_f23d9d3ab432fad375281464cce94609]['dateCutSet'] = $dateCutSet;
}
...
" . ((is_array($sortIn) AND count( $sortIn )) ? ("
	<div class='ipsFilterPane' id='filter_section_pane' style='display: none'>
		...
		<div>
			...
			<ul>
				".$this->__f__86a8e86513d8ec32f14f710029bad731($results,$pagination,$total,$sortDropDown,$sortIn,$dateCutSet)."			</ul>
		</div>
	</div>
") : ("")) . "
...
function __f__59dfa108b4cade8f090c20e7c876f19a($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getApplications() as $app )
...
function __f__86a8e86513d8ec32f14f710029bad731($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a4409d9606f570de9079d43bd2853f2e = is_array($this->functionData['searchAdvancedForm']) ? count($this->functionData['searchAdvancedForm']) : 0;
$this->functionData['searchAdvancedForm'][$count_a4409d9606f570de9079d43bd2853f2e]['filters'] = $filters;
$this->functionData['searchAdvancedForm'][$count_a4409d9606f570de9079d43bd2853f2e]['msg'] = $msg;
$this->functionData['searchAdvancedForm'][$count_a4409d9606f570de9079d43bd2853f2e]['current_app'] = $current_app;
$this->functionData['searchAdvancedForm'][$count_a4409d9606f570de9079d43bd2853f2e]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchAdvancedForm'][$count_a4409d9606f570de9079d43bd2853f2e]['isFT'] = $isFT;
$this->functionData['searchAdvancedForm'][$count_a4409d9606f570de9079d43bd2853f2e]['canTag'] = $canTag;
}
...
<div class='master_list ipsForm_vertical'>
	...
	" . ((count($filters)) ? ("".$this->__f__d10152fff01b717e3259b67a493bdeff($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag)."		") : ("")) . "
	<div class='submit'>
...
function __f__4ac1cd16f0afd13ece6b96e68be873d4($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='',$id='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__126d033ce461e1cbd1a53acf26ce7326($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
							<ul>
								<li>
									...
									".$this->__f__4ac1cd16f0afd13ece6b96e68be873d4($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data,$id,$_data)."									</select>
...
function __f__33b8c26ec500f5dd7e1a5e357073fa11($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d10152fff01b717e3259b67a493bdeff($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . (($app == 'forums') ? ("<div id='app_filter_{$app}'>
				...
				" . ((count($data['sortDropDown'])) ? ("" . ((is_array($data['sortDropIn']) AND count( $data['sortDropIn'] )) ? ("
						".$this->__f__126d033ce461e1cbd1a53acf26ce7326($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."					") : ("<div class='ipsField'>
							...
							<select name='search_app_filters[$app][sortKey]' id='search_sort_by_{$app}' class='input_select' style='width:auto'>
								".$this->__f__33b8c26ec500f5dd7e1a5e357073fa11($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."							</select>
...
{
$count_7d10b4685558881f256a83eda195e6ff = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_7d10b4685558881f256a83eda195e6ff]['results'] = $results;
$this->functionData['searchResults'][$count_7d10b4685558881f256a83eda195e6ff]['titlesOnly'] = $titlesOnly;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($results) && count($results)) ? ("
			".$this->__f__8bbcf89940c23ab395a0005f78c9a625($results,$titlesOnly)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__8bbcf89940c23ab395a0005f78c9a625($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $result )
...
{
$count_caa665aa88c72daeaa66a9aaf18355b8 = is_array($this->functionData['searchResultsWrapper']) ? count($this->functionData['searchResultsWrapper']) : 0;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['results'] = $results;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['sortDropDown'] = $sortDropDown;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['sortIn'] = $sortIn;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['pagination'] = $pagination;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['total'] = $total;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['showing'] = $showing;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['search_term'] = $search_term;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['url_string'] = $url_string;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['current_key'] = $current_key;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['limited'] = $limited;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['wasLimited'] = $wasLimited;
$this->functionData['searchResultsWrapper'][$count_caa665aa88c72daeaa66a9aaf18355b8]['search_tags'] = $search_tags;
}
...
{
$count_068655c26a01388b87ea792224dfdaef = is_array($this->functionData['searchRowGenericFormat']) ? count($this->functionData['searchRowGenericFormat']) : 0;
$this->functionData['searchRowGenericFormat'][$count_068655c26a01388b87ea792224dfdaef]['r'] = $r;
$this->functionData['searchRowGenericFormat'][$count_068655c26a01388b87ea792224dfdaef]['resultAsTitle'] = $resultAsTitle;
}
$IPBHTML .= "<div class='result_info'>
...
{
$count_9f66bdd7d0621cf89f3fefc3cde85d11 = is_array($this->functionData['topicPostSearchResultAsForum']) ? count($this->functionData['topicPostSearchResultAsForum']) : 0;
$this->functionData['topicPostSearchResultAsForum'][$count_9f66bdd7d0621cf89f3fefc3cde85d11]['data'] = $data;
$this->functionData['topicPostSearchResultAsForum'][$count_9f66bdd7d0621cf89f3fefc3cde85d11]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_8713b6a35a9332456d57513690e2f4fd = is_array($this->functionData['userPostsView']) ? count($this->functionData['userPostsView']) : 0;
$this->functionData['userPostsView'][$count_8713b6a35a9332456d57513690e2f4fd]['results'] = $results;
$this->functionData['userPostsView'][$count_8713b6a35a9332456d57513690e2f4fd]['pagination'] = $pagination;
$this->functionData['userPostsView'][$count_8713b6a35a9332456d57513690e2f4fd]['total'] = $total;
$this->functionData['userPostsView'][$count_8713b6a35a9332456d57513690e2f4fd]['member'] = $member;
$this->functionData['userPostsView'][$count_8713b6a35a9332456d57513690e2f4fd]['limited'] = $limited;
$this->functionData['userPostsView'][$count_8713b6a35a9332456d57513690e2f4fd]['wasLimited'] = $wasLimited;
$this->functionData['userPostsView'][$count_8713b6a35a9332456d57513690e2f4fd]['beginTime'] = $beginTime;
$this->functionData['userPostsView'][$count_8713b6a35a9332456d57513690e2f4fd]['sortIn'] = $sortIn;
$this->functionData['userPostsView'][$count_8713b6a35a9332456d57513690e2f4fd]['sortDropDown'] = $sortDropDown;
}
