...
{
$count_5a3be36261258b91782e0f294c3d5c49 = is_array($this->functionData['showOnlineList']) ? count($this->functionData['showOnlineList']) : 0;
$this->functionData['showOnlineList'][$count_5a3be36261258b91782e0f294c3d5c49]['rows'] = $rows;
$this->functionData['showOnlineList'][$count_5a3be36261258b91782e0f294c3d5c49]['links'] = $links;
$this->functionData['showOnlineList'][$count_5a3be36261258b91782e0f294c3d5c49]['defaults'] = $defaults;
}
...
<div class='ipsBox removeDefault'>
	<div class='ipsBox_container'>
		<table class='ipb_table ipsMemberList' summary=\"{$this->lang->words['users_online']}\">
			...
			" . ((count($rows)) ? ("
								".$this->__f__809c42bbf4b12bf15b2032adda49bcc1($rows,$links,$defaults)."			") : ("")) . "
		</table>
	</div>
...
<div id='forum_filter' class='ipsForm_center ipsPad'>
	<form method=\"post\" action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;section=online&amp;module=online", "public",'' ), "", "" ) . "\">
		...
		<select name=\"sort_key\" id='sort_key' class='input_select'>
			".$this->__f__4845f445919f7eceec1d9af659eba4ad($rows,$links,$defaults)."		</select>
		<select name=\"show_mem\" class='input_select'>
			".$this->__f__f77e06ddeb029f8ea0b73d3328a37274($rows,$links,$defaults)."		</select>
		<select name=\"sort_order\" class='input_select'>
			".$this->__f__09bbc5321c5da8032fe34b94c506a314($rows,$links,$defaults)."		</select>
...
function __f__809c42bbf4b12bf15b2032adda49bcc1($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4845f445919f7eceec1d9af659eba4ad($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f77e06ddeb029f8ea0b73d3328a37274($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__09bbc5321c5da8032fe34b94c506a314($rows, $links="", $defaults=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
