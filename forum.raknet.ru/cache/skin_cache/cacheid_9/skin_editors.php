...
{
$count_cbc4c997a72c7d9fca4094b988bf6932 = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_cbc4c997a72c7d9fca4094b988bf6932]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_cbc4c997a72c7d9fca4094b988bf6932]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_cbc4c997a72c7d9fca4094b988bf6932]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_cbc4c997a72c7d9fca4094b988bf6932]['extraData'] = $extraData;
}
...
{
$count_bf0cf2bb38eaf5dc34e33096a08daec8 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_bf0cf2bb38eaf5dc34e33096a08daec8]['formField'] = $formField;
$this->functionData['editor'][$count_bf0cf2bb38eaf5dc34e33096a08daec8]['content'] = $content;
$this->functionData['editor'][$count_bf0cf2bb38eaf5dc34e33096a08daec8]['options'] = $options;
$this->functionData['editor'][$count_bf0cf2bb38eaf5dc34e33096a08daec8]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_bf0cf2bb38eaf5dc34e33096a08daec8]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_bf0cf2bb38eaf5dc34e33096a08daec8]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_bf0cf2bb38eaf5dc34e33096a08daec8]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_bf0cf2bb38eaf5dc34e33096a08daec8]['showEditor'] = $showEditor;
}
...
{
$count_2ca07825da3f24213256aefc5e9a7f0b = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_2ca07825da3f24213256aefc5e9a7f0b]['options'] = $options;
$this->functionData['editorLoadJs'][$count_2ca07825da3f24213256aefc5e9a7f0b]['inlineLoad'] = $inlineLoad;
}
...
{
$count_60198894a79b5cddd933ae62014cb5d9 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_60198894a79b5cddd933ae62014cb5d9]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_60198894a79b5cddd933ae62014cb5d9]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_60198894a79b5cddd933ae62014cb5d9]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_60198894a79b5cddd933ae62014cb5d9]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__3a1c140c9b59422c28b03887b97af6af($rows,$pages,$app,$plugin)."		") : ("
...
function __f__3a1c140c9b59422c28b03887b97af6af($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_e7219fe5ef8bab82e07900eea49490fb = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_e7219fe5ef8bab82e07900eea49490fb]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__0e072851f21602ce313b54c27c3603a5($tabs)."			</ul>
		</div>
...
function __f__0e072851f21602ce313b54c27c3603a5($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )
