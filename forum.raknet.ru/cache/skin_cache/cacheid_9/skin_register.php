...
{
$count_fdf0236ad9b00dc8f003607cce59b11a = is_array($this->functionData['completePartialLogin']) ? count($this->functionData['completePartialLogin']) : 0;
$this->functionData['completePartialLogin'][$count_fdf0236ad9b00dc8f003607cce59b11a]['mid'] = $mid;
$this->functionData['completePartialLogin'][$count_fdf0236ad9b00dc8f003607cce59b11a]['key'] = $key;
$this->functionData['completePartialLogin'][$count_fdf0236ad9b00dc8f003607cce59b11a]['custom_fields'] = $custom_fields;
$this->functionData['completePartialLogin'][$count_fdf0236ad9b00dc8f003607cce59b11a]['errors'] = $errors;
$this->functionData['completePartialLogin'][$count_fdf0236ad9b00dc8f003607cce59b11a]['reg'] = $reg;
$this->functionData['completePartialLogin'][$count_fdf0236ad9b00dc8f003607cce59b11a]['userFromService'] = $userFromService;
}
...
<div id='register_form'>	
	...
	<div id='connect_new'>
		<br />
		" . $this->registry->getClass('output')->getReplacement("header_start") . "<h2 class='maintitle'>{$this->lang->words['new_account_title']}</h2>" . $this->registry->getClass('output')->getReplacement("header_end") . "
		<div class='ipsBox'>
						...
						<ul class='ipsForm ipsForm_horizontal ipsPad'>
							...
							" . (($custom_fields != '') ? ("<fieldset class='rcomplete'>
								" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
									".$this->__f__b355a196aa4472bf5488e1bf78e294c5($mid,$key,$custom_fields,$errors,$reg,$userFromService)."								") : ("")) . "
	
								" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
									".$this->__f__027e0efcc4105c002961a7508fdaa06c($mid,$key,$custom_fields,$errors,$reg,$userFromService)."								") : ("")) . "
								</fieldset>") : ("")) . "
						</ul>
					</fieldset>
	...
	" . ((count( $userFromService ) AND ! empty( $userFromService['service'] )) ? ("
		...
		<div id='connect_existing'>
			" . $this->registry->getClass('output')->getReplacement("header_start") . "<h2 class='maintitle'>{$this->lang->words['connect_account_title']}</h2>" . $this->registry->getClass('output')->getReplacement("header_end") . "
			<div class='ipsBox'>
...
function __f__b355a196aa4472bf5488e1bf78e294c5($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__027e0efcc4105c002961a7508fdaa06c($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4b5b23eff7cd5dd25dfa06037c1961a6 = is_array($this->functionData['lostPasswordForm']) ? count($this->functionData['lostPasswordForm']) : 0;
$this->functionData['lostPasswordForm'][$count_4b5b23eff7cd5dd25dfa06037c1961a6]['errors'] = $errors;
}
...
" . $this->registry->getClass('output')->getReplacement("header_start") . "<h2 class='maintitle'>{$this->lang->words['recover_password']}</h2>" . $this->registry->getClass('output')->getReplacement("header_end") . "
...
{
$count_9c0f57b76bb53f98bb47719b5745c48c = is_array($this->functionData['registerCoppaForm']) ? count($this->functionData['registerCoppaForm']) : 0;
}
$IPBHTML .= "<html>
	<head>
...
{
$count_72db05352705a42760e035b28482f5c7 = is_array($this->functionData['registerCoppaStart']) ? count($this->functionData['registerCoppaStart']) : 0;
}
		...
		<fieldset class='general_box'>
			...
			<div class='ipsPad ipsForm_center'>
				...
				<select name='month' id='coppa_bday_m'>
					".$this->__f__47516b3b6f2896f590b0e1c9d59cf02a()."				</select>
				&nbsp;
				<select name='day' id='coppa_bday_d'>
					".$this->__f__0225da2ad88f16513fb3ae6fd2e2eb3d()."				</select>
				&nbsp;
				<select name='year' id='coppa_bday_y'>
					".$this->__f__dddc99fd5cf5ed8fb6a8667c075c2b97()."				</select>
			</div>
		</fieldset>
...
function __f__47516b3b6f2896f590b0e1c9d59cf02a()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0225da2ad88f16513fb3ae6fd2e2eb3d()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__dddc99fd5cf5ed8fb6a8667c075c2b97()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1749914948a128deb8da78856a93fda7 = is_array($this->functionData['registerForm']) ? count($this->functionData['registerForm']) : 0;
$this->functionData['registerForm'][$count_1749914948a128deb8da78856a93fda7]['general_errors'] = $general_errors;
$this->functionData['registerForm'][$count_1749914948a128deb8da78856a93fda7]['data'] = $data;
$this->functionData['registerForm'][$count_1749914948a128deb8da78856a93fda7]['inline_errors'] = $inline_errors;
$this->functionData['registerForm'][$count_1749914948a128deb8da78856a93fda7]['time_select'] = $time_select;
$this->functionData['registerForm'][$count_1749914948a128deb8da78856a93fda7]['custom_fields'] = $custom_fields;
$this->functionData['registerForm'][$count_1749914948a128deb8da78856a93fda7]['nexusFields'] = $nexusFields;
$this->functionData['registerForm'][$count_1749914948a128deb8da78856a93fda7]['nexusStates'] = $nexusStates;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("register", "0" ) . "
<script type='text/javascript'>
//<![CDATA[
...
<div id='register_form'>
	...
	<div class='message error'>
		...
		<ul>
			".$this->__f__010dbfc7c9672cedbaf8350d8f1db8eb($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."		</ul>
	</div>
	<br />
	") : ("")) . "
			...
			<div class='resize_form'>
				...
				" . ((!empty( $nexusFields )) ? ("
					<script type='text/javascript'>
						...
						".$this->__f__ad8d5a5ad20f2dc5c961f177abd2f583($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."					</script>
					<hr />
					<fieldset>
						<ul class='ipsForm ipsForm_horizontal'>
							".$this->__f__1e1d53db0bda9015d960dba4cf419fb1($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						</ul>
					</fieldset>
					<script type='text/javascript'>
						function states()
						{
				...
				" . ((( is_array( $custom_fields['required'] ) && count( $custom_fields['required'] ) ) || ( is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] ) )) ? ("<hr />
					<fieldset>
						<ul class='ipsForm ipsForm_horizontal'>
						" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
							".$this->__f__535166ea9bd4ee8751f455262688aab0($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
			
						" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
							".$this->__f__0d71ab4630d7ecc4fe454f4e860be5f2($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
					</fieldset>") : ("")) . "
				<hr />
				{$data['qandaHTML']}
				{$data['captchaHTML']}
...
function __f__010dbfc7c9672cedbaf8350d8f1db8eb($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ad8d5a5ad20f2dc5c961f177abd2f583($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__26489c5b6b54b063214881e785b484cf($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( explode( "\n", $f['f_extra'] ) as $k => $v )
...
function __f__b5d446c3bd9858cb0a7e2e83e2bee2de($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='',$country='',$_states='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a996fa6d24b0d938294ff2f257877b9f($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array(),$f='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $nexusStates as $country => $_states )
	{
		...
		$_ips___x_retval .= "
												<select name='_cm_state' id='{$country}-states' class='input_select' style='display:none'>
													".$this->__f__b5d446c3bd9858cb0a7e2e83e2bee2de($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f,$country,$_states)."												</select>
...
function __f__1e1d53db0bda9015d960dba4cf419fb1($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
								...
								" . (($f['f_type'] == 'dropdown') ? ("<li class='ipsField clear'>
										...
										<div class='ipsField_content'>
											<select name='{$f['f_column']}' id='{$f['f_column']}' tabindex='5' " . (($f['f_column'] == 'cm_country') ? ("onchange='states()'") : ("")) . ">
												".$this->__f__26489c5b6b54b063214881e785b484cf($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f)."											</select>
										</div>
										" . (($f['f_reg_require'] and $this->request['do'] == 'process_form' and !$this->request[ $f['f_column'] ]) ? ("
											<span class='error'>{$this->lang->words['err_complete_form']}</span>
										") : ("")) . "
								...
								" . (($f['f_type'] == 'special') ? ("<li class='ipsField clear'>
										...
										<div class='ipsField_content'>
											...
											".$this->__f__a996fa6d24b0d938294ff2f257877b9f($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates,$f)."										</div>
										" . (($f['f_reg_require'] and $this->request['do'] == 'process_form' and !$this->request[ $f['f_column'] ]) ? ("
											<span class='error'>{$this->lang->words['err_complete_form']}</span>
										") : ("")) . "
									</li>") : ("")) . "
...
function __f__535166ea9bd4ee8751f455262688aab0($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['required'] as $_field )
...
function __f__0d71ab4630d7ecc4fe454f4e860be5f2($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['optional'] as $_field )
...
$IPBHTML .= "<div id='register_form'>
	" . ( method_exists( $this->registry->getClass('output')->getTemplate('register'), 'registerStepBar' ) ? $this->registry->getClass('output')->getTemplate('register')->registerStepBar(array('register_form' => '', 'confirmation' => 'ipsSteps_active')) : '' ) . "" . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>{$this->lang->words['ready_register']}</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
	<div class='ipsBox removeDefault'>
		<div class='ipsBox_container ipsPad'>
...
{
$count_36fd93846e6d3451585808214eb8f98e = is_array($this->functionData['showLostpassForm']) ? count($this->functionData['showLostpassForm']) : 0;
$this->functionData['showLostpassForm'][$count_36fd93846e6d3451585808214eb8f98e]['error'] = $error;
}
...
{
$count_530f10ad32c2799e0ae9c22849c9d334 = is_array($this->functionData['showRevalidateForm']) ? count($this->functionData['showRevalidateForm']) : 0;
$this->functionData['showRevalidateForm'][$count_530f10ad32c2799e0ae9c22849c9d334]['name'] = $name;
$this->functionData['showRevalidateForm'][$count_530f10ad32c2799e0ae9c22849c9d334]['error'] = $error;
}
$IPBHTML .= "<h1 class='ipsType_pagetitle'>{$this->lang->words['rv_title']}</h1>
<br />
" . (($error) ? ("
