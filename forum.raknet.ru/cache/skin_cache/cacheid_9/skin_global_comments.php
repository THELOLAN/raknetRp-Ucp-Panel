...
{
$count_387d3b49686b29e0c016eb37aaceeb6f = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_387d3b49686b29e0c016eb37aaceeb6f]['r'] = $r;
$this->functionData['comment'][$count_387d3b49686b29e0c016eb37aaceeb6f]['parent'] = $parent;
$this->functionData['comment'][$count_387d3b49686b29e0c016eb37aaceeb6f]['settings'] = $settings;
}
...
{
$count_aab711fda61087fecf81d333fd8d1d20 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_aab711fda61087fecf81d333fd8d1d20]['r'] = $r;
$this->functionData['commentHidden'][$count_aab711fda61087fecf81d333fd8d1d20]['parent'] = $parent;
$this->functionData['commentHidden'][$count_aab711fda61087fecf81d333fd8d1d20]['settings'] = $settings;
}
...
{
$count_fe2dd561e09238e0c25b12489d07e0c1 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_fe2dd561e09238e0c25b12489d07e0c1]['comments'] = $comments;
$this->functionData['commentsList'][$count_fe2dd561e09238e0c25b12489d07e0c1]['settings'] = $settings;
$this->functionData['commentsList'][$count_fe2dd561e09238e0c25b12489d07e0c1]['pages'] = $pages;
$this->functionData['commentsList'][$count_fe2dd561e09238e0c25b12489d07e0c1]['parent'] = $parent;
$this->functionData['commentsList'][$count_fe2dd561e09238e0c25b12489d07e0c1]['preReply'] = $preReply;
}
...
") : ("")) . "
" . ((($comments) AND (IPS_APP_COMPONENT != 'ccs')) ? ("<div class='ipsBox'><div class='ipsBox_container'>") : ("")) . "
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__76c46f46c5cd1579a17fab79abad65c6($comments,$settings,$pages,$parent,$preReply)."</div>
" . ((($comments) AND (IPS_APP_COMPONENT != 'ccs')) ? ("</div></div>") : ("")) . "
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
") : ("")) . "
" . (($parent['_canComment']) ? ("<a id=\"fastreply\"></a>
" . ((IPS_APP_COMPONENT != 'ccs') ? ("<div class='ipsBox' style='margin-top: 10px;'><div class='ipsBox_container'>") : ("")) . "
...
function __f__76c46f46c5cd1579a17fab79abad65c6($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $comments as $id => $r )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "" . (($r['comment']['_canView']) ? ("" . (($r['comment']['comment_approved'] == -1) ? ("
...
{
$count_45ec2bfab6e1610a08933283e90ae345 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_45ec2bfab6e1610a08933283e90ae345]['comment'] = $comment;
$this->functionData['form'][$count_45ec2bfab6e1610a08933283e90ae345]['parent'] = $parent;
$this->functionData['form'][$count_45ec2bfab6e1610a08933283e90ae345]['editor'] = $editor;
$this->functionData['form'][$count_45ec2bfab6e1610a08933283e90ae345]['settings'] = $settings;
$this->functionData['form'][$count_45ec2bfab6e1610a08933283e90ae345]['errors'] = $errors;
$this->functionData['form'][$count_45ec2bfab6e1610a08933283e90ae345]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
