...
$IPBHTML = "";
$IPBHTML .= "" . $this->registry->getClass('output')->getReplacement("header_start") . "<h2 class='maintitle'>{$this->lang->words['report_basic_title']}</h2>" . $this->registry->getClass('output')->getReplacement("header_end") . "
...
<form action=\"{$this->settings['base_url']}app=core&amp;module=reports&amp;rcom={$this->request['rcom']}&amp;send=1\" method=\"post\" name=\"REPLIER\">
	...
	<div class='ipsForm ipsForm_horizontal row1'>
		<fieldset>
			<h3 class='bar noTopBorder'>{$this->lang->words['reporting_title']} <a href=\"{$url}\" title='{$this->lang->words['view_content']}'>{$name}</a></h3>
			<ul class='ipsPad'>
				<li class='ipsField clearfix'>
					...
					<p class='ipsField_content'>
						...
						<div class='desc line_height' style='padding-top: 10px; padding-left: 205px;'>{$this->lang->words['report_basic_desc']}</div>
					</p>
				</li>
				{$extra_data}
				{$captchaHTML}
...
{
$count_9953f54bc265f624bff54544dd6a3f72 = is_array($this->functionData['reportsIndex']) ? count($this->functionData['reportsIndex']) : 0;
$this->functionData['reportsIndex'][$count_9953f54bc265f624bff54544dd6a3f72]['reports'] = $reports;
$this->functionData['reportsIndex'][$count_9953f54bc265f624bff54544dd6a3f72]['acts'] = $acts;
$this->functionData['reportsIndex'][$count_9953f54bc265f624bff54544dd6a3f72]['pages'] = $pages;
$this->functionData['reportsIndex'][$count_9953f54bc265f624bff54544dd6a3f72]['statuses'] = $statuses;
}
...
<table class='ipb_table report_center' summary='{$this->lang->words['reported_content_summary']}'>
	...
	" . ((count($reports)) ? ("
				".$this->__f__db14b88dc2554ed51bd891d33f4a0c94($reports,$acts,$pages,$statuses)."	") : ("
		<tr>
...
function __f__ec57a88979c787f750687f9946620e70($reports=array(), $acts="", $pages="", $statuses=array(),$report='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__db14b88dc2554ed51bd891d33f4a0c94($reports=array(), $acts="", $pages="", $statuses=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
				...
				<td>
					...
					" . ((is_array( $statuses ) && count( $statuses )) ? ("
						<ul class='ipbmenu_content' id='change_status-{$report['id']}_menucontent' style='display:none;'>
							".$this->__f__ec57a88979c787f750687f9946620e70($reports,$acts,$pages,$statuses,$report)."						</ul>
					") : ("")) . "
				</td>
				<td class='altrow'>
...
{
$count_bcb648b504739fc380c2f826f486fd8b = is_array($this->functionData['viewReport']) ? count($this->functionData['viewReport']) : 0;
$this->functionData['viewReport'][$count_bcb648b504739fc380c2f826f486fd8b]['options'] = $options;
$this->functionData['viewReport'][$count_bcb648b504739fc380c2f826f486fd8b]['reports'] = $reports;
$this->functionData['viewReport'][$count_bcb648b504739fc380c2f826f486fd8b]['comments'] = $comments;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("reports", "0" ) . "
<div class='message'>
...
" . ((is_array( $options['statuses'] ) && count( $options['statuses'] )) ? ("
	<ul class='ipbmenu_content' id='change_status_menucontent'>
		".$this->__f__19fd3bfb6793696b1e9b034da104dcdd($options,$reports,$comments)."	</ul>
") : ("")) . "
<br />
<div class='topic hfeed'>
" . $this->registry->getClass('output')->getReplacement("header_start") . "<h2 class='maintitle'>{$this->lang->words['reports_h2']}</h2>" . $this->registry->getClass('output')->getReplacement("header_end") . "
<div class='generic_bar'></div>
" . ((is_array($reports) AND count($reports)) ? ("
	".$this->__f__fea2c960ea7ad5cf9885e6a743ab95d6($options,$reports,$comments)."") : ("")) . "" . $this->registry->getClass('output')->getReplacement("box_end") . "
</div>
<br /><hr /><br />
<div class='ipsBox'>
...
function __f__19fd3bfb6793696b1e9b034da104dcdd($options=array(), $reports=array(), $comments=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fea2c960ea7ad5cf9885e6a743ab95d6($options=array(), $reports=array(), $comments=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reports as $report )
