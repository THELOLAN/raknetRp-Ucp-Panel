...
{
$count_cb3e47211e22ea99038ebf5073bd02d5 = is_array($this->functionData['forumAttachments']) ? count($this->functionData['forumAttachments']) : 0;
$this->functionData['forumAttachments'][$count_cb3e47211e22ea99038ebf5073bd02d5]['title'] = $title;
$this->functionData['forumAttachments'][$count_cb3e47211e22ea99038ebf5073bd02d5]['rows'] = $rows;
$this->functionData['forumAttachments'][$count_cb3e47211e22ea99038ebf5073bd02d5]['pages'] = $pages;
}
...
<table class='ipb_table'>
	<tr class='header'>
		...
		" . ((count($rows)) ? ("".$this->__f__3079f7bbe3efac27b1e615fb543db0d6($title,$rows,$pages)."	") : ("")) . "
</table>
" . (($pages) ? ("
	<br />
	<div class='topic_controls'>{$pages}</div>
...
function __f__3079f7bbe3efac27b1e615fb543db0d6($title, $rows, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_875f418dabba2cbe604568c35d4b0e43 = is_array($this->functionData['forumIndexTemplate']) ? count($this->functionData['forumIndexTemplate']) : 0;
$this->functionData['forumIndexTemplate'][$count_875f418dabba2cbe604568c35d4b0e43]['forum_data'] = $forum_data;
$this->functionData['forumIndexTemplate'][$count_875f418dabba2cbe604568c35d4b0e43]['announce_data'] = $announce_data;
$this->functionData['forumIndexTemplate'][$count_875f418dabba2cbe604568c35d4b0e43]['topic_data'] = $topic_data;
$this->functionData['forumIndexTemplate'][$count_875f418dabba2cbe604568c35d4b0e43]['other_data'] = $other_data;
$this->functionData['forumIndexTemplate'][$count_875f418dabba2cbe604568c35d4b0e43]['multi_mod_data'] = $multi_mod_data;
$this->functionData['forumIndexTemplate'][$count_875f418dabba2cbe604568c35d4b0e43]['sub_forum_data'] = $sub_forum_data;
$this->functionData['forumIndexTemplate'][$count_875f418dabba2cbe604568c35d4b0e43]['footer_filter'] = $footer_filter;
$this->functionData['forumIndexTemplate'][$count_875f418dabba2cbe604568c35d4b0e43]['active_user_data'] = $active_user_data;
$this->functionData['forumIndexTemplate'][$count_875f418dabba2cbe604568c35d4b0e43]['mod_data'] = $mod_data;
$this->functionData['forumIndexTemplate'][$count_875f418dabba2cbe604568c35d4b0e43]['inforum'] = $inforum;
}
...
" . ((is_array( $announce_data ) AND count( $announce_data )) ? ("
	<div class='content_border'><table class='ipb_table topic_list hover_rows' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='announcements'>
		".$this->__f__40d2bdfd89a8ef131b8a411f0186be31($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."	</table></div>
	<br />	
") : ("")) . "
<!-- __-SUBFORUMS-__ -->
" . ((is_array( $sub_forum_data ) AND count( $sub_forum_data )) ? ("
	<div class='category_block block_wrap'>
		" . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>{$this->lang->words['sub_forum_title']}</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
		<div class='ipsBox table_wrap removeDefault'>
			<div class='ipsBox_container'>
				<table class='ipb_table' summary=\"{$this->lang->words['cat_subforums']} '{$forum_data['name']}'\">
					".$this->__f__dd4c63a547a376c83fc87a56947e8872($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				</table>
			</div>
...
" . (($forum_data['sub_can_post']) ? ("<div class='topic_controls clearfix'>
	...
	" . $this->registry->getClass('output')->getReplacement("header_start") . "<div class='ipsFilterbar maintitle'>
		" . (($this->memberData['is_mod'] == 1) ? ("
			<span class='right'>
		...
		<div class='ipsBox_container'>
			<table class='ipb_table topic_list hover_rows " . (($this->memberData['is_mod'] == 1) ? ("is_mod") : ("")) . "' summary='{$this->lang->words['forum_topic_list']} \"{$forum_data['name']}\"' id='forum_table'>
				...
				" . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
					".$this->__f__ac6934550a99061b4402192417bf66cf($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."				") : ("<tr> 
						" . (($this->memberData['is_mod'] == 1) ? ("
	...
	<div id='forum_footer' class='statistics clear clearfix'>
		" . ((is_array( $mod_data ) AND count( $mod_data )) ? ("
			<div id='forum_led_by' class='right ipsType_small'>
				...
				".$this->__f__0a557f57c73f40c2602e9ecaf35e56ca($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."			</div>
		") : ("")) . "
...
" . ((is_array( $multi_mod_data ) AND count( $multi_mod_data )) ? ("
    ".$this->__f__8dca18e3e84a67498ec10dc5bea4f2ef($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum)."") : ("")) . "
</select>";
return $IPBHTML;
}


function __f__40d2bdfd89a8ef131b8a411f0186be31($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__bdbfc2e164b7e832b6eb9672e2ba2dfb($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='',$forum_id='',$forum_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__69925997efdf4ee8f48373bf5d2d981f($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1,$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
								" . (($forum_data['redirect_on']) ? ("<tr class='redirect_forum' id='f_{$forum_data['id']}'>
										...
										<td " . (($this->memberData['gbw_view_last_info']) ? ("colspan='2'") : ("")) . " class='col_c_forum'>
											<h4><strong><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showforum={$forum_data['id']}", "public",'' ), "{$forum_data['name_seo']}", "showforum" ) . "\" title='{$forum_data['name']}'>{$forum_data['name']}</a></strong></h4>
										...
										<td class='col_c_forum'>									
											...
											" . (($forum_data['show_subforums'] AND count( $forum_data['subforums'] ) AND $forum_data['show_subforums']) ? ("
												<ol class='ipsList_inline ipsType_small subforums' id='subforums_{$forum_data['id']}'>
													".$this->__f__bdbfc2e164b7e832b6eb9672e2ba2dfb($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data,$forum_id,$forum_data)."												</ol>
											") : ("")) . "
...
" . (($this->memberData['gbw_view_last_info']) ? ("<td class='col_c_post'>
											...
											") : ("" . (($forum_data['_hide_last_date']) ? ("
												...
												<ul class='last_post ipsType_small'>
													...
													") : ("<li><span class='highlight_unread'>{$forum_data['last_topic_title']}</span></li>
                                                        <li>
                                                            ...
                                                            " . (($forum_data['last_poster_id']) ? ("
																{$this->lang->words['by_ucfirst']} " . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userHoverCard' ) ? $this->registry->getClass('output')->getTemplate('global')->userHoverCard($forum_data) : '' ) . "
															") : ("")) . "
...
function __f__dd4c63a547a376c83fc87a56947e8872($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $sub_forum_data as $_data )
	{
		...
		$_ips___x_retval .= "
						" . ((is_array( $_data['forum_data'] ) AND count( $_data['forum_data'] )) ? ("
							".$this->__f__69925997efdf4ee8f48373bf5d2d981f($forum_data,$announce_data,$topic_data,$other_data,$multi_mod_data,$sub_forum_data,$footer_filter,$active_user_data,$mod_data,$inforum,$_data)."						") : ("")) . "
...
function __f__ac6934550a99061b4402192417bf66cf($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0a557f57c73f40c2602e9ecaf35e56ca($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8dca18e3e84a67498ec10dc5bea4f2ef($forum_data, $announce_data, $topic_data, $other_data, $multi_mod_data, $sub_forum_data, $footer_filter, $active_user_data, $mod_data, $inforum=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
" . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>{$this->lang->words['need_password']}</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
<div class='row1 ipsPad'>
	<input type=\"hidden\" name=\"L\" value=\"1\" />

	<div class='message unspecific'>{$this->lang->words['need_password_txt']}</div>
...
{
$count_cd2c8f8bb136385e8e81265671eb9b47 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_cd2c8f8bb136385e8e81265671eb9b47]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_cd2c8f8bb136385e8e81265671eb9b47]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_cd2c8f8bb136385e8e81265671eb9b47]['opts'] = $opts;
}
...
{
$count_a23b5919757125d5c7755476409aa95d = is_array($this->functionData['topic']) ? count($this->functionData['topic']) : 0;
$this->functionData['topic'][$count_a23b5919757125d5c7755476409aa95d]['data'] = $data;
$this->functionData['topic'][$count_a23b5919757125d5c7755476409aa95d]['forum_data'] = $forum_data;
$this->functionData['topic'][$count_a23b5919757125d5c7755476409aa95d]['other_data'] = $other_data;
$this->functionData['topic'][$count_a23b5919757125d5c7755476409aa95d]['inforum'] = $inforum;
}
$IPBHTML .= "" . ((($this->memberData['is_mod'] AND ! $data['approved']) OR $data['_isDeleted']) ? ("<tr itemscope itemtype=\"http://schema.org/Article\" class='__topic " . ((!$data['folder_img']['is_read']) ? ("unread") : ("")) . " expandable moderated' id='trow_{$data['_tid']}' data-tid=\"{$data['_tid']}\">") : ("<tr itemscope itemtype=\"http://schema.org/Article\" class='__topic " . ((!$data['folder_img']['is_read']) ? ("unread") : ("notnew")) . " expandable' id='trow_{$data['_tid']}' data-tid=\"{$data['_tid']}\">")) . "
...
" . (($data['_answeredPid'] !== false) ? ("
		...
		" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
			...
			".$this->__f__be3112c798bfaa629d4119819465e262($data,$forum_data,$other_data,$inforum)."			</ul>
		") : ("")) . "
	</td>
...
function __f__1d524cfbd2629f6a508ac1f408c977c0($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__be3112c798bfaa629d4119819465e262($data, $forum_data, $other_data, $inforum)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c98157a34debfb3bff14ee066c8b75f9 = is_array($this->functionData['topic_rating_image']) ? count($this->functionData['topic_rating_image']) : 0;
$this->functionData['topic_rating_image'][$count_c98157a34debfb3bff14ee066c8b75f9]['rating_id'] = $rating_id;
}
$IPBHTML .= "<span class='mini_rate'>".$this->__f__c09de497a2eaee9b882516f252088abb($rating_id)."</span>";
return $IPBHTML;
}


function __f__c09de497a2eaee9b882516f252088abb($rating_id=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_98532878962f9f19f40e88561090bbbe = is_array($this->functionData['topicPrefixWrap']) ? count($this->functionData['topicPrefixWrap']) : 0;
$this->functionData['topicPrefixWrap'][$count_98532878962f9f19f40e88561090bbbe]['text'] = $text;
}
$IPBHTML .= "" . (($text) ? ("
