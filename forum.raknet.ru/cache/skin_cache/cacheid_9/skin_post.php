...
{
$count_9105b40d5a57a63ec98d380966dcddb0 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_9105b40d5a57a63ec98d380966dcddb0]['data'] = $data;
}
...
{
$count_9541353b5df1926bd8fbcd982d4c4309 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_9541353b5df1926bd8fbcd982d4c4309]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_9541353b5df1926bd8fbcd982d4c4309]['form'] = $form;
}
...
") : ("")) . "
" . $this->registry->getClass('output')->addJSModule("post", "0" ) . "<!--FORUM RULES-->
" . $this->registry->getClass('output')->getReplacement("header_start") . "<h2 class='maintitle'>{$formData['title']}</h2>" . $this->registry->getClass('output')->getReplacement("header_end") . "
...
</form>" . $this->registry->getClass('output')->getReplacement("box_end") . "
...
{
$count_15dfeefd834ab9050054f76a7a62d65f = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_15dfeefd834ab9050054f76a7a62d65f]['data'] = $data;
}
$IPBHTML .= "" . (($data AND trim($data) != '<br />' AND trim($data) != '<br>') ? ("" . ((!$this->settings['disable_lightbox']) ? ("
	...
	") : ("")) . "
	" . $this->registry->getClass('output')->getReplacement("header_start") . "<h2 class='maintitle'>{$this->lang->words['post_preview']}</h2>" . $this->registry->getClass('output')->getReplacement("header_end") . "
<div class='post_block no_sidebar'>
	<div class='post_wrap ipsBox' id='post_preview'>
		<div class='ipsBox_container ipsPad'>
			<div class='post_body'><div class='post entry-content'>{$data}</div></div>
		</div>
	</div>
...
{
$count_00a044817390d62e7e7e9498bc65c8f5 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_00a044817390d62e7e7e9498bc65c8f5]['posts'] = $posts;
}
...
<br /><br />
" . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>{$this->lang->words['topic_summary']}</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
<div class='generic_bar'></div>
<div id='topic_summary'>
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__941986391d21236018fca919c8138c59($posts)."") : ("")) . "
<p class='submit'>
...
function __f__941986391d21236018fca919c8138c59($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $posts as $pid => $data )
	{
		...
		<div class='post_block no_sidebar topic_summary'>
			<div class='post_wrap'>
				<h3><span class='right ipsType_small'>{$this->lang->words['summary_posted']} {$data['date']}</span>
				<strong>" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userHoverCard' ) ? $this->registry->getClass('output')->getTemplate('global')->userHoverCard($data) : '' ) . "</strong></h3>
				<div class='post_body'>
...
{
$count_4c9499f5076e053020055650290d1073 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_4c9499f5076e053020055650290d1073]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_4c9499f5076e053020055650290d1073]['type'] = $type;
$this->functionData['uploadForm'][$count_4c9499f5076e053020055650290d1073]['stats'] = $stats;
$this->functionData['uploadForm'][$count_4c9499f5076e053020055650290d1073]['id'] = $id;
$this->functionData['uploadForm'][$count_4c9499f5076e053020055650290d1073]['forum_id'] = $forum_id;
}
