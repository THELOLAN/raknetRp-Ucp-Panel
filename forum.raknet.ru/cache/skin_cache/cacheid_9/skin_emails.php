...
{
$count_5a6b7bba660ae9315773210b8c187279 = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_5a6b7bba660ae9315773210b8c187279]['title'] = $title;
$this->functionData['forward_form'][$count_5a6b7bba660ae9315773210b8c187279]['text'] = $text;
$this->functionData['forward_form'][$count_5a6b7bba660ae9315773210b8c187279]['lang'] = $lang;
$this->functionData['forward_form'][$count_5a6b7bba660ae9315773210b8c187279]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_5a6b7bba660ae9315773210b8c187279]['msg'] = $msg;
}
$IPBHTML .= "<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=forward", "public",'' ), "", "" ) . "\" method=\"post\" name='REPLIER'>
	...
	" . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>{$this->lang->words['title']}</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__04adcaeaf716e591148fa50a48c080bd($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__04adcaeaf716e591148fa50a48c080bd($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
