...
{
$count_8b23f9fafe6b18b96e1cccaf3e3ed574 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_8b23f9fafe6b18b96e1cccaf3e3ed574]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_8b23f9fafe6b18b96e1cccaf3e3ed574]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_8b23f9fafe6b18b96e1cccaf3e3ed574]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_8b23f9fafe6b18b96e1cccaf3e3ed574]['sharelinks'] = $sharelinks;
}
...
{
$count_c3a0d5b3b4249d70feea006a1c7c03fd = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_c3a0d5b3b4249d70feea006a1c7c03fd]['announce'] = $announce;
$this->functionData['announcement_show'][$count_c3a0d5b3b4249d70feea006a1c7c03fd]['author'] = $author;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("topic", "0" ) . "
" . $this->registry->getClass('output')->getReplacement("header_start") . "<h2 class='maintitle'>{$this->lang->words['announce_title']}: {$announce['announce_title']}
<span class='right'>{$this->lang->words['posted_by']} " . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'userHoverCard' ) ? $this->registry->getClass('output')->getTemplate('global')->userHoverCard($author) : '' ) . "</span>
...
{
$count_db8122e78ec87cfae55311b0a6686397 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_db8122e78ec87cfae55311b0a6686397]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_db8122e78ec87cfae55311b0a6686397]['forum'] = $forum;
}
...
{
$count_0f08ae924878f5e30f1fe69ca4fa360f = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_fab5fdc7f74512ba621d784462005bea = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_fab5fdc7f74512ba621d784462005bea]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_fab5fdc7f74512ba621d784462005bea]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_fab5fdc7f74512ba621d784462005bea]['opts'] = $opts;
}
...
{
$count_f27ca1e0bcbf16123a6d5a5da8769d8c = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_f27ca1e0bcbf16123a6d5a5da8769d8c]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_f27ca1e0bcbf16123a6d5a5da8769d8c]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_f27ca1e0bcbf16123a6d5a5da8769d8c]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_f27ca1e0bcbf16123a6d5a5da8769d8c]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_f27ca1e0bcbf16123a6d5a5da8769d8c]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_f27ca1e0bcbf16123a6d5a5da8769d8c]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__c558a353eccada86962f044c0b4a835e($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__9e8be809e21fd81c37f0fea0ae678611($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d7a72dff463f03e16444effd7da75112($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__9e8be809e21fd81c37f0fea0ae678611($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__c558a353eccada86962f044c0b4a835e($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__d7a72dff463f03e16444effd7da75112($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_048ce4be03e511b8c9f39f3eff6b1468 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_048ce4be03e511b8c9f39f3eff6b1468]['post'] = $post;
$this->functionData['post'][$count_048ce4be03e511b8c9f39f3eff6b1468]['displayData'] = $displayData;
$this->functionData['post'][$count_048ce4be03e511b8c9f39f3eff6b1468]['topic'] = $topic;
$this->functionData['post'][$count_048ce4be03e511b8c9f39f3eff6b1468]['forum'] = $forum;
}
...
") : ("")) . "
" . ((! $post['post']['_isDeleted']) ? ("<div class='post_block hentry clear clearfix " . (($post['post']['_isMarkedAnswered']) ? ("solved") : ("")) . " column_view " . (($post['post']['_isHidden']) ? ("moderated") : ("")) . "' id='post_id_{$post['post']['pid']}'>
		...
		<div class='post_wrap' " . (($post['post']['_ignored'] == 1 || $post['post']['_repignored'] == 1) ? ("style='display: none'") : ("")) . ">
			...
			")) . "
				...
				" . (($post['author']['_online']) ? ("<img src=\"{style_images_url}/post_online.png\" alt=\"\" class='post_online' data-tooltip=\"Online\" />") : ("<img src=\"{style_images_url}/post_offline.png\" alt=\"\" class='post_online' data-tooltip=\"Offline\" />")) . "
...
" . (($post['post']['_isMarkedAnswered']) ? ("<div class='answerBadgeInPost'>&#10003; &nbsp;{$this->lang->words['topic_best_answer']}</div>") : ("")) . "
				...
				<ul id='postControlsNormal_{$post['post']['pid']}' class='post_controls clear clearfix' " . (($this->memberData['is_mod'] && ! $topic['_isArchived'] && $post['post']['queued']) ? ("style='display:none'") : ("")) . ">
                    ...
                    " . (($topic['Perms']['canAnswerTopic'] && $post['post']['post_count'] > 1) ? ("" . (($post['post']['_isMarkedAnswered']) ? ("" . (($post['post']['_canMarkUnanswered']) ? ("
                                <li> <a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=extras&amp;section=answer&amp;do=unanswer&amp;t={$this->request['t']}&amp;pid={$post['post']['pid']}&amp;auth_key={$this->member->form_hash}", "publicWithApp",'' ), "", "" ) . "\" data-post-button=\"unanswer\" data-pid=\"{$post['post']['pid']}\"> <img class='icon' src=\"{$this->settings['img_url']}/cross_white_10px.png\">{$this->lang->words['topic_mark_unsolved']}</a> </li>
                            ") : ("")) . "") : ("" . (($post['post']['_canAnswer'] && $topic['topic_firstpost'] != $post['post']['pid']) ? ("
                                <li> <a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=extras&amp;section=answer&amp;do=answer&amp;t={$this->request['t']}&amp;pid={$post['post']['pid']}&amp;auth_key={$this->member->form_hash}", "publicWithApp",'' ), "", "" ) . "\" data-post-button=\"answer\" data-pid=\"{$post['post']['pid']}\"> <img class='icon' src=\"{$this->settings['img_url']}/tick_10px.png\">{$this->lang->words['topic_mark_solved']}</a> </li>
                            ") : ("")) . "")) . "") : ("")) . "
" . ((!$this->memberData['unacknowledged_warnings'] && !$this->memberData['restrict_post']) ? ("" . (($post['post']['_canReply']) ? ("<li><a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=post&amp;section=post&amp;do=reply_post&amp;f={$this->request['f']}&amp;t={$this->request['t']}&amp;qpid={$post['post']['pid']}", "publicWithApp",'' ), "", "" ) . "\"  class='_ips_trigger_quote' pid=\"{$post['post']['pid']}\" title=\"{$this->lang->words['tt_reply_to_post']}\"><img src=\"{style_images_url}/comment_new.png\" alt=\"\" /> {$this->lang->words['post_reply']}</a></li>
						...
						")) . "
							<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=post&amp;section=post&amp;do=reply_post&amp;f={$this->request['f']}&amp;t={$this->request['t']}&amp;qpid={$post['post']['pid']}", "publicWithApp",'' ), "", "" ) . "\" title=\"{$this->lang->words['quote_with_mq']}\"><img src=\"{style_images_url}/mq_post.png\" alt=\"\" /> {$this->lang->words['mq']}</a>
						</li>") : ("")) . "") : ("")) . "
					" . (($post['post']['_can_delete'] === TRUE && ! $topic['_isArchived']) ? ("
					...
					" . (($post['post']['_softDelete'] && ! $topic['_isArchived']) ? ("
						<li id='hide_post_{$post['post']['pid']}'>
							<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=moderate&amp;section=moderate&amp;do=postchoice&amp;tact=delete&amp;f={$topic['forum_id']}&amp;t={$topic['tid']}&amp;selectedpids[]={$post['post']['pid']}&amp;page={$this->request['page']}&amp;auth_key={$this->member->form_hash}", "publicWithApp",'' ), "", "" ) . "' class='hide_post'><img src=\"{style_images_url}/delete.png\" alt=\"\" /> {$this->lang->words['post_hide']}</a>
						</li>
					") : ("")) . "
					" . (($post['post']['_can_edit'] === TRUE) ? ("
					...
					" . (($topic['_canReport'] and ! $topic['_isArchived']) ? ("<li class='report'>
							<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=reports&amp;rcom=post&amp;tid={$this->request['t']}&amp;pid={$post['post']['pid']}&amp;page={$this->request['page']}", "public",'' ), "", "" ) . "'><img src=\"{style_images_url}/report.png\" alt=\"\" /> {$this->lang->words['report']}</a>
						</li>
...
{
$count_8f9ae076a6917dfd5b99aa4a28c3665b = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_8f9ae076a6917dfd5b99aa4a28c3665b]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_4101af2cf76e55b813a3a9c43f61ac67 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_4101af2cf76e55b813a3a9c43f61ac67]['title'] = $title;
$this->functionData['show_attachment_title'][$count_4101af2cf76e55b813a3a9c43f61ac67]['data'] = $data;
$this->functionData['show_attachment_title'][$count_4101af2cf76e55b813a3a9c43f61ac67]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__dcce1fedcc8e8b31f0e7c579f0863f0c($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__dcce1fedcc8e8b31f0e7c579f0863f0c($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f81cf92cfc7d3f40e9575837fbf9d184 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_f81cf92cfc7d3f40e9575837fbf9d184]['data'] = $data;
}
...
{
$count_42919284efc48bc22b3dd3b8be13aed9 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_42919284efc48bc22b3dd3b8be13aed9]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_42919284efc48bc22b3dd3b8be13aed9]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_42919284efc48bc22b3dd3b8be13aed9]['topic'] = $topic;
}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__8014fd30f22b2b29c4f79adfd82b412b($topic,$posts)."<br class='clear' />
...
function __f__8014fd30f22b2b29c4f79adfd82b412b($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_464dfcd052ff3a642411e64e2d4dafeb = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_464dfcd052ff3a642411e64e2d4dafeb]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_464dfcd052ff3a642411e64e2d4dafeb]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_464dfcd052ff3a642411e64e2d4dafeb]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_464dfcd052ff3a642411e64e2d4dafeb]['displayData'] = $displayData;
}
...
<div itemscope itemtype=\"http://schema.org/Article\" class='ipsBox_withphoto'>
	" . (($this->memberData['member_id']) ? ("<span class='right'>{$displayData['follow_data']}</span>") : ("")) . "
    <h1 itemprop=\"name\" class='ipsType_pagetitle'>
		{$topic['title']}
	</h1>
    " . (($forum['forum_allow_rating']) ? ("<span itemprop=\"aggregateRating\" itemscope itemtype=\"http://schema.org/AggregateRating\" class='rating ipsType_smaller right'>
			" . (($topic['_allow_rate']) ? ("
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__1f2c4a129dce4693352951960f3632d0($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__912b9e5dc691280d68e7ba167e00da19($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . $this->registry->getClass('output')->getReplacement("header_start") . "<div class='maintitle clear clearfix'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__a36cfe3f1d4f3b501f46597d3f5b8a13($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__308c91b0e7f5301c2500b928eed9f301($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
...
" . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>{$this->lang->words['topic_add_reply']}</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
<div class='ipsBox removeDefault' id='fast_reply_wrapper'>
	<div class='ipsBox_container ipsPad'>
		" . (($topic['state'] == 'closed') ? ("<div class='message error'>{$this->lang->words['locked_reply_fr']}</div>") : ("")) . "
		<br />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
    <br />
        " . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>" . sprintf( $this->lang->words['topic_same_tagged_as'], $topic['tags']['formatted']['string'] ) . "</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
        <div class='ipsBox_container removeDefault'>
            <table class='ipb_table topic_list'>
            ".$this->__f__0dce80b625fbaa87a402084b0dc18cd7($forum,$topic,$post_data,$displayData)."            </table>
        </div>" . $this->registry->getClass('output')->getReplacement("box_end") . "
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__1f2c4a129dce4693352951960f3632d0($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__912b9e5dc691280d68e7ba167e00da19($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a36cfe3f1d4f3b501f46597d3f5b8a13($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__308c91b0e7f5301c2500b928eed9f301($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0dce80b625fbaa87a402084b0dc18cd7($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
