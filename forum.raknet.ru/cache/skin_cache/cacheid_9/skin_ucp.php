...
{
$count_6da7237bf75ffc9af03d4d6c8b9fa4f4 = is_array($this->functionData['coreAttachments']) ? count($this->functionData['coreAttachments']) : 0;
$this->functionData['coreAttachments'][$count_6da7237bf75ffc9af03d4d6c8b9fa4f4]['info'] = $info;
$this->functionData['coreAttachments'][$count_6da7237bf75ffc9af03d4d6c8b9fa4f4]['pages'] = $pages;
$this->functionData['coreAttachments'][$count_6da7237bf75ffc9af03d4d6c8b9fa4f4]['attachments'] = $attachments;
}
...
<div class='row1'>	
	...
	<div class='content_border'><table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		<tr class='header'>
			...
			" . ((count($attachments)) ? ("
								".$this->__f__444006f3a6b2543351c80df864c56df9($info,$pages,$attachments)."			") : ("
				<tr>
...
function __f__444006f3a6b2543351c80df864c56df9($info="",$pages="",$attachments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f0ea5b0dbadb330fd7866d7e5cbb764c = is_array($this->functionData['displayNameForm']) ? count($this->functionData['displayNameForm']) : 0;
$this->functionData['displayNameForm'][$count_f0ea5b0dbadb330fd7866d7e5cbb764c]['form'] = $form;
$this->functionData['displayNameForm'][$count_f0ea5b0dbadb330fd7866d7e5cbb764c]['error'] = $error;
$this->functionData['displayNameForm'][$count_f0ea5b0dbadb330fd7866d7e5cbb764c]['okmessage'] = $okmessage;
$this->functionData['displayNameForm'][$count_f0ea5b0dbadb330fd7866d7e5cbb764c]['isFB'] = $isFB;
}
$IPBHTML .= "" . (($okmessage != "") ? ("
...
{
$count_768911cad850461ba64ce6dae85669fb = is_array($this->functionData['emailPasswordChangeForm']) ? count($this->functionData['emailPasswordChangeForm']) : 0;
$this->functionData['emailPasswordChangeForm'][$count_768911cad850461ba64ce6dae85669fb]['txt'] = $txt;
$this->functionData['emailPasswordChangeForm'][$count_768911cad850461ba64ce6dae85669fb]['_message'] = $_message;
$this->functionData['emailPasswordChangeForm'][$count_768911cad850461ba64ce6dae85669fb]['isFB'] = $isFB;
}
...
{
$count_5e5bab0c7cffadf7e3572ac64d6be5f3 = is_array($this->functionData['field_entry']) ? count($this->functionData['field_entry']) : 0;
$this->functionData['field_entry'][$count_5e5bab0c7cffadf7e3572ac64d6be5f3]['title'] = $title;
$this->functionData['field_entry'][$count_5e5bab0c7cffadf7e3572ac64d6be5f3]['desc'] = $desc;
$this->functionData['field_entry'][$count_5e5bab0c7cffadf7e3572ac64d6be5f3]['content'] = $content;
$this->functionData['field_entry'][$count_5e5bab0c7cffadf7e3572ac64d6be5f3]['id'] = $id;
}
...
{
$count_7ec1ef09bfb058c2dc7557d97cea4bde = is_array($this->functionData['membersFacebookConnect']) ? count($this->functionData['membersFacebookConnect']) : 0;
$this->functionData['membersFacebookConnect'][$count_7ec1ef09bfb058c2dc7557d97cea4bde]['fbuid'] = $fbuid;
$this->functionData['membersFacebookConnect'][$count_7ec1ef09bfb058c2dc7557d97cea4bde]['fbUserData'] = $fbUserData;
$this->functionData['membersFacebookConnect'][$count_7ec1ef09bfb058c2dc7557d97cea4bde]['linkedMemberData'] = $linkedMemberData;
$this->functionData['membersFacebookConnect'][$count_7ec1ef09bfb058c2dc7557d97cea4bde]['perms'] = $perms;
$this->functionData['membersFacebookConnect'][$count_7ec1ef09bfb058c2dc7557d97cea4bde]['missingPerms'] = $missingPerms;
}
...
{
$count_3c806b99c4849ff31fe5dfafc0297b5a = is_array($this->functionData['membersIgnoredUsersForm']) ? count($this->functionData['membersIgnoredUsersForm']) : 0;
$this->functionData['membersIgnoredUsersForm'][$count_3c806b99c4849ff31fe5dfafc0297b5a]['members'] = $members;
}
...
<div class='content_border'><table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
	<tr class='header'>
		...
		" . ((count( $members )) ? ("".$this->__f__45978bb433e52f1844ff5de8d284b7e9($members)."	") : ("<tr>
...
function __f__45978bb433e52f1844ff5de8d284b7e9($members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_f6486b93cdd45d42935b96aaea6ac7ae = is_array($this->functionData['membersProfileForm']) ? count($this->functionData['membersProfileForm']) : 0;
$this->functionData['membersProfileForm'][$count_f6486b93cdd45d42935b96aaea6ac7ae]['custom_fields'] = $custom_fields;
$this->functionData['membersProfileForm'][$count_f6486b93cdd45d42935b96aaea6ac7ae]['group_titles'] = $group_titles;
$this->functionData['membersProfileForm'][$count_f6486b93cdd45d42935b96aaea6ac7ae]['day'] = $day;
$this->functionData['membersProfileForm'][$count_f6486b93cdd45d42935b96aaea6ac7ae]['mon'] = $mon;
$this->functionData['membersProfileForm'][$count_f6486b93cdd45d42935b96aaea6ac7ae]['year'] = $year;
$this->functionData['membersProfileForm'][$count_f6486b93cdd45d42935b96aaea6ac7ae]['amEditor'] = $amEditor;
$this->functionData['membersProfileForm'][$count_f6486b93cdd45d42935b96aaea6ac7ae]['times'] = $times;
}
...
<div class='ipsSettings'>
		...
		<div>
			<ul class='ipsForm ipsForm_horizontal'>
				<li class='ipsField'>
					...
					".$this->__f__83a36764f771c5faaeac9d58061c74e9($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."					</select><br />
				...
				" . (($day AND $mon AND $year) ? ("
					...
					<ul>
						<li>
							...
							<select name=\"month\">&nbsp;
								".$this->__f__97c8db0607be8a60016f7fbe29568bbc($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select>			
							<select name=\"day\">&nbsp;
								".$this->__f__c42d999c0d58f91d2d42b7185fd2e8e3($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select> 
							<select name=\"year\">&nbsp;
								".$this->__f__4fb8fcdb29a4f06e5a793fddff718893($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select> <br />
	...
	" . ((count( $custom_fields )) ? ("".$this->__f__d36ed4ac483b70e7cabab2baba2bcd5d($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."	") : ("")) . "
...
function __f__83a36764f771c5faaeac9d58061c74e9($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__97c8db0607be8a60016f7fbe29568bbc($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mon as $m )
...
function __f__c42d999c0d58f91d2d42b7185fd2e8e3($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day as $d )
...
function __f__4fb8fcdb29a4f06e5a793fddff718893($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $year as $y )
...
function __f__477ac084329e769d3b031ce01cf01abe($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array(),$cgroup='',$cfields='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d36ed4ac483b70e7cabab2baba2bcd5d($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . ((count( $cfields )) ? ("
				<fieldset class='ipsSettings_section'>
					...
					<div>
						<ul>
							".$this->__f__477ac084329e769d3b031ce01cf01abe($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times,$cgroup,$cfields)."						</ul>
					</div>
				</fieldset>
			") : ("")) . "
...
{
$count_2c451c9bf8067bff63e3e88980fdbf8e = is_array($this->functionData['membersSignatureForm']) ? count($this->functionData['membersSignatureForm']) : 0;
$this->functionData['membersSignatureForm'][$count_2c451c9bf8067bff63e3e88980fdbf8e]['editor_html'] = $editor_html;
$this->functionData['membersSignatureForm'][$count_2c451c9bf8067bff63e3e88980fdbf8e]['sig_restrictions'] = $sig_restrictions;
$this->functionData['membersSignatureForm'][$count_2c451c9bf8067bff63e3e88980fdbf8e]['signature'] = $signature;
}
...
{
$count_a2a1d92bccc0fa9ddd683676d13ebcf1 = is_array($this->functionData['membersTwitterConnect']) ? count($this->functionData['membersTwitterConnect']) : 0;
$this->functionData['membersTwitterConnect'][$count_a2a1d92bccc0fa9ddd683676d13ebcf1]['isConnected'] = $isConnected;
$this->functionData['membersTwitterConnect'][$count_a2a1d92bccc0fa9ddd683676d13ebcf1]['twitterUser'] = $twitterUser;
}
...
{
$count_b42e181a3aef562d790125aeccc28998 = is_array($this->functionData['notificationsForm']) ? count($this->functionData['notificationsForm']) : 0;
$this->functionData['notificationsForm'][$count_b42e181a3aef562d790125aeccc28998]['config'] = $config;
$this->functionData['notificationsForm'][$count_b42e181a3aef562d790125aeccc28998]['emailData'] = $emailData;
}
...
<fieldset class='row1'>
	<div class='message unspecific' style='margin-top: 5px;'>{$this->lang->words['notifications_info_acp']}</div>
		...
		".$this->__f__ba152eb83f69999df7084168c670d139($config,$emailData)."		".$this->__f__cd59e1f3a91fb9563a3203941d064cef($config,$emailData)."	</table>
</fieldset>";
return $IPBHTML;
}


function __f__9c2d0984be9fb94ce99923b9ae8e48a1($config, $emailData,$groupKey='',$group='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ba152eb83f69999df7084168c670d139($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->notifyGroups as $groupKey => $group )
	{
		...
		$_ips___x_retval .= "
			...
			".$this->__f__9c2d0984be9fb94ce99923b9ae8e48a1($config,$emailData,$groupKey,$group)."							
...
function __f__cd59e1f3a91fb9563a3203941d064cef($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b026c497f40d633f34f956a5abe447c8 = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_b026c497f40d633f34f956a5abe447c8]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_b026c497f40d633f34f956a5abe447c8]['error'] = $error;
$this->functionData['notificationsLog'][$count_b026c497f40d633f34f956a5abe447c8]['pages'] = $pages;
}
		...
		<table class='ipb_table' summary=\"{$this->lang->words['notifications_table_head']}\">
			<tr class='header hide'>
				...
				<th scope='col' align=\"center\" width=\"5%\" class='short'>&nbsp;</th>
						...
						".$this->__f__06089e19ebba547c75c46a09843e30f2($notifications,$error,$pages)."		</table>
		<script type='text/javascript'>
...
function __f__06089e19ebba547c75c46a09843e30f2($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d0726a8c3192597b90a258f1cb211a21 = is_array($this->functionData['userCPTemplate']) ? count($this->functionData['userCPTemplate']) : 0;
$this->functionData['userCPTemplate'][$count_d0726a8c3192597b90a258f1cb211a21]['current_tab'] = $current_tab;
$this->functionData['userCPTemplate'][$count_d0726a8c3192597b90a258f1cb211a21]['html'] = $html;
$this->functionData['userCPTemplate'][$count_d0726a8c3192597b90a258f1cb211a21]['tabs'] = $tabs;
$this->functionData['userCPTemplate'][$count_d0726a8c3192597b90a258f1cb211a21]['current_area'] = $current_area;
$this->functionData['userCPTemplate'][$count_d0726a8c3192597b90a258f1cb211a21]['errors'] = $errors;
$this->functionData['userCPTemplate'][$count_d0726a8c3192597b90a258f1cb211a21]['hide_form'] = $hide_form;
$this->functionData['userCPTemplate'][$count_d0726a8c3192597b90a258f1cb211a21]['maxUpload'] = $maxUpload;
}
...
<br />
" . ((count($tabs) > 1) ? ("" . $this->registry->getClass('output')->getReplacement("header_start") . "<div class='maintitle ipsFilterbar clearfix'>
		<ul class='ipsList_inline'>
			".$this->__f__e7c870b320cf5dc39ca1b289f120b5a4($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."		</ul>
	...
	<div class='ipsLayout" . (($hasMoreTabs) ? (" ipsLayout_withleft ipsLayout_smallleft ipsVerticalTabbed") : ("")) . " clearfix usercp_body'>
		" . (($hasMoreTabs) ? ("
			<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='usercp_tabs'>
				<ul>
					".$this->__f__f1341092daf6f7191e9966aa287adf58($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."				</ul>
			</div>
		") : ("")) . "
		<div class='" . (($hasMoreTabs) ? ("ipsVerticalTabbed_content ") : ("")) . "ipsLayout_content ipsBox_container' id='usercp_content'>
			<div class='ipsPad'>
				" . ((is_array( $errors ) AND count( $errors )) ? ("
					<p class='message error'>
						".$this->__f__427c12f7fe54147cd6bd75618da3db33($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."					</p>
					<br />
				") : ("")) . "
...
" . ((count($tabs) > 1) ? ("" . $this->registry->getClass('output')->getReplacement("box_end") . "") : ("")) . "
" . (($hide_form == 0) ? ("
</form>
") : ("")) . "";
return $IPBHTML;
...
function __f__e7c870b320cf5dc39ca1b289f120b5a4($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f1341092daf6f7191e9966aa287adf58($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__427c12f7fe54147cd6bd75618da3db33($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
