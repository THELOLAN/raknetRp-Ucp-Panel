...
{
$count_6a3a90771f30997c0f45629b0cb4d51f = is_array($this->functionData['ajaxPopUpNoPermission']) ? count($this->functionData['ajaxPopUpNoPermission']) : 0;
$this->functionData['ajaxPopUpNoPermission'][$count_6a3a90771f30997c0f45629b0cb4d51f]['msg'] = $msg;
}
...
{
$count_7ebb93aaf776ccd4aa0359704b483ba8 = is_array($this->functionData['displayBoardOffline']) ? count($this->functionData['displayBoardOffline']) : 0;
$this->functionData['displayBoardOffline'][$count_7ebb93aaf776ccd4aa0359704b483ba8]['message'] = $message;
}
...
{
$count_34ea96db874d8e6079ee4855706e9fca = is_array($this->functionData['displayPopUpWindow']) ? count($this->functionData['displayPopUpWindow']) : 0;
$this->functionData['displayPopUpWindow'][$count_34ea96db874d8e6079ee4855706e9fca]['documentHeadItems'] = $documentHeadItems;
$this->functionData['displayPopUpWindow'][$count_34ea96db874d8e6079ee4855706e9fca]['css'] = $css;
$this->functionData['displayPopUpWindow'][$count_34ea96db874d8e6079ee4855706e9fca]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['displayPopUpWindow'][$count_34ea96db874d8e6079ee4855706e9fca]['title'] = $title;
$this->functionData['displayPopUpWindow'][$count_34ea96db874d8e6079ee4855706e9fca]['output'] = $output;
}
...
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\">
	<head>
		...
		" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
			".$this->__f__8d0573749531faeb908ec8022ae39cc0($documentHeadItems,$css,$jsLoaderItems,$title,$output)."			" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
		...
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__64e7b35dcc2e519ee630f187600ce67a($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<!--[if lte IE 7]>
		...
		" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
			".$this->__f__ac2341d13933d74ed91956a0d3642fa7($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<script type='text/javascript'>
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__5a9dcf0b4c92f28bb71f063f0278688c($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
...
function __f__8d0573749531faeb908ec8022ae39cc0($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__64e7b35dcc2e519ee630f187600ce67a($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ac2341d13933d74ed91956a0d3642fa7($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__af881939c5c03d970034d230c8bae2d6($documentHeadItems, $css, $jsLoaderItems, $title="", $output="",$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5a9dcf0b4c92f28bb71f063f0278688c($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__af881939c5c03d970034d230c8bae2d6($documentHeadItems,$css,$jsLoaderItems,$title,$output,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_c05d99ac87d6676b9c894348c6e7e47f = is_array($this->functionData['Error']) ? count($this->functionData['Error']) : 0;
$this->functionData['Error'][$count_c05d99ac87d6676b9c894348c6e7e47f]['message'] = $message;
$this->functionData['Error'][$count_c05d99ac87d6676b9c894348c6e7e47f]['code'] = $code;
$this->functionData['Error'][$count_c05d99ac87d6676b9c894348c6e7e47f]['ad_email_one'] = $ad_email_one;
$this->functionData['Error'][$count_c05d99ac87d6676b9c894348c6e7e47f]['ad_email_two'] = $ad_email_two;
$this->functionData['Error'][$count_c05d99ac87d6676b9c894348c6e7e47f]['title'] = $title;
}
...
{
$count_38e1f0e6dc931294d503cf1937a78587 = is_array($this->functionData['facebookPop']) ? count($this->functionData['facebookPop']) : 0;
$this->functionData['facebookPop'][$count_38e1f0e6dc931294d503cf1937a78587]['user'] = $user;
}
...
{
$count_3fa4b59538af52f3ada124629859f5fa = is_array($this->functionData['generateTopicIcon']) ? count($this->functionData['generateTopicIcon']) : 0;
$this->functionData['generateTopicIcon'][$count_3fa4b59538af52f3ada124629859f5fa]['imgArray'] = $imgArray;
$this->functionData['generateTopicIcon'][$count_3fa4b59538af52f3ada124629859f5fa]['unreadUrl'] = $unreadUrl;
}
...
") : ("")) . "
" . ((empty( $unreadUrl ) && ! $imgArray['is_moved']) ? ("" . (($imgArray['show_dot']) ? ("" . $this->registry->getClass('output')->getReplacement("t_read_dot") . "") : ("<img src=\"{style_images_url}/t_read.png\" alt=\"\" />")) . "") : ("")) . "
...
{
$count_c03612b1e1db44a2c1ae052d4ca339b0 = is_array($this->functionData['globalTemplateMinimal']) ? count($this->functionData['globalTemplateMinimal']) : 0;
$this->functionData['globalTemplateMinimal'][$count_c03612b1e1db44a2c1ae052d4ca339b0]['html'] = $html;
$this->functionData['globalTemplateMinimal'][$count_c03612b1e1db44a2c1ae052d4ca339b0]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplateMinimal'][$count_c03612b1e1db44a2c1ae052d4ca339b0]['css'] = $css;
$this->functionData['globalTemplateMinimal'][$count_c03612b1e1db44a2c1ae052d4ca339b0]['jsModules'] = $jsModules;
$this->functionData['globalTemplateMinimal'][$count_c03612b1e1db44a2c1ae052d4ca339b0]['metaTags'] = $metaTags;
$this->functionData['globalTemplateMinimal'][$count_c03612b1e1db44a2c1ae052d4ca339b0]['header_items'] = $header_items;
$this->functionData['globalTemplateMinimal'][$count_c03612b1e1db44a2c1ae052d4ca339b0]['items'] = $items;
$this->functionData['globalTemplateMinimal'][$count_c03612b1e1db44a2c1ae052d4ca339b0]['footer_items'] = $footer_items;
$this->functionData['globalTemplateMinimal'][$count_c03612b1e1db44a2c1ae052d4ca339b0]['stats'] = $stats;
}
...
function __f__6e6b1b0a7229b5ad7d2b57911ed447b7($topics)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7e97dab80f430946a7beaf5c1bcf5a38 = is_array($this->functionData['likeMoreDialogue']) ? count($this->functionData['likeMoreDialogue']) : 0;
$this->functionData['likeMoreDialogue'][$count_7e97dab80f430946a7beaf5c1bcf5a38]['data'] = $data;
$this->functionData['likeMoreDialogue'][$count_7e97dab80f430946a7beaf5c1bcf5a38]['relId'] = $relId;
$this->functionData['likeMoreDialogue'][$count_7e97dab80f430946a7beaf5c1bcf5a38]['cache'] = $cache;
}
$IPBHTML .= "<h3>{$this->lang->words['followed_by']}</h3>
<div class='likepop fixed_inner'>
	" . ((is_array($data) && count($data)) ? ("
		<ul class='ipsList_withminiphoto'>
			".$this->__f__c68026cbb157f8824d11a8a01bc23704($data,$relId,$cache)."		</ul>
	") : ("")) . "
...
function __f__c68026cbb157f8824d11a8a01bc23704($data, $relId, $cache)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		<li class='ipsField ipsField_checkbox'>
			...
			<p class='ipsField_content'>
				...
				<select name=\"freq\" id=\"like_freq\" class=\"input_select\">
					".$this->__f__801c93f06e1ec11e26175843283a0d74($app,$area,$relid,$data)."				</select>
			</p>
		</li>
		<li class='ipsField ipsField_checkbox'>
...
function __f__801c93f06e1ec11e26175843283a0d74($app, $area, $relid, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_992b3c283bd22e0137c6c641c05efb3e = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_992b3c283bd22e0137c6c641c05efb3e]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_992b3c283bd22e0137c6c641c05efb3e]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_992b3c283bd22e0137c6c641c05efb3e]['opts'] = $opts;
}
...
{
$count_a12846043907c098e0314ca63cdf1d90 = is_array($this->functionData['notificationsList']) ? count($this->functionData['notificationsList']) : 0;
$this->functionData['notificationsList'][$count_a12846043907c098e0314ca63cdf1d90]['notifications'] = $notifications;
}
...
<ul class='ipsList_withminiphoto'>
	" . ((count($notifications)) ? ("
		".$this->__f__8a6b9899288fcf2beb8ba143a3bf479c($notifications)."	") : ("
...
function __f__8a6b9899288fcf2beb8ba143a3bf479c($notifications)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML = "";
$IPBHTML .= "" . $this->registry->getClass('output')->getReplacement("header_start") . "<h2 class='maintitle'>{$title}</h2>" . $this->registry->getClass('output')->getReplacement("header_end") . "
...
{
$count_34637d13c27755c1e52185cecf3c23e9 = is_array($this->functionData['questionAndAnswer']) ? count($this->functionData['questionAndAnswer']) : 0;
$this->functionData['questionAndAnswer'][$count_34637d13c27755c1e52185cecf3c23e9]['data'] = $data;
}
...
{
$count_9aad35636d5a940e4961ce9ffe8244e3 = is_array($this->functionData['quickNavigationPanel']) ? count($this->functionData['quickNavigationPanel']) : 0;
$this->functionData['quickNavigationPanel'][$count_9aad35636d5a940e4961ce9ffe8244e3]['data'] = $data;
$this->functionData['quickNavigationPanel'][$count_9aad35636d5a940e4961ce9ffe8244e3]['currentApp'] = $currentApp;
}
$IPBHTML .= "<div>
	".$this->__f__42408b21211757aaf99f13fca01997f1($data,$currentApp)."</div>";
return $IPBHTML;
}


function __f__fd41ca2c017202e5fb25fcce3b3a237d($data=array(), $currentApp='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__42408b21211757aaf99f13fca01997f1($data=array(), $currentApp='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $_data )
	{
		...
		" . ((is_array($_data['links']) AND count($_data['links'])) ? ("
			".$this->__f__fd41ca2c017202e5fb25fcce3b3a237d($data,$currentApp,$_data)."		") : ("")) . "
		</ul>
...
{
$count_9b65c96e3fc307c6269c8e59e69e128d = is_array($this->functionData['quickNavigationWrapper']) ? count($this->functionData['quickNavigationWrapper']) : 0;
$this->functionData['quickNavigationWrapper'][$count_9b65c96e3fc307c6269c8e59e69e128d]['tabs'] = $tabs;
$this->functionData['quickNavigationWrapper'][$count_9b65c96e3fc307c6269c8e59e69e128d]['data'] = $data;
$this->functionData['quickNavigationWrapper'][$count_9b65c96e3fc307c6269c8e59e69e128d]['currentApp'] = $currentApp;
}
$IPBHTML .= "<h3>{$this->lang->words['navigation_title']}</h3>
<div class='fixed_inner ipsBox'>
	" . (($this->registry->output->isLargeTouchDevice()) ? ("
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul>
				".$this->__f__dcb813dc8012853eb2e815874b100939($tabs,$data,$currentApp)."			</ul>
		</div>
...
function __f__dcb813dc8012853eb2e815874b100939($tabs=array(), $data=array(), $currentApp='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b7cc29711f7a4a3d1b834fbe04207c41 = is_array($this->functionData['redirectTemplate']) ? count($this->functionData['redirectTemplate']) : 0;
$this->functionData['redirectTemplate'][$count_b7cc29711f7a4a3d1b834fbe04207c41]['documentHeadItems'] = $documentHeadItems;
$this->functionData['redirectTemplate'][$count_b7cc29711f7a4a3d1b834fbe04207c41]['css'] = $css;
$this->functionData['redirectTemplate'][$count_b7cc29711f7a4a3d1b834fbe04207c41]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['redirectTemplate'][$count_b7cc29711f7a4a3d1b834fbe04207c41]['text'] = $text;
$this->functionData['redirectTemplate'][$count_b7cc29711f7a4a3d1b834fbe04207c41]['url'] = $url;
$this->functionData['redirectTemplate'][$count_b7cc29711f7a4a3d1b834fbe04207c41]['full'] = $full;
}
$IPBHTML .= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\">
	<head>
		...
		<link rel=\"shortcut icon\" href='" . (($this->registry->output->isHTTPS) ? ("{$this->settings['board_url_https']}") : ("{$this->settings['board_url']}")) . "/favicon.ico' />
		" . ((is_array( $css['import'] )) ? ("
			".$this->__f__d8a0e43179dfbc0cc37a86bb1eb9d3ae($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__62555185116a1cca8552ab1f23f198ba($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--[if lte IE 7]>
			<link rel=\"stylesheet\" type=\"text/css\" title='Main' media=\"screen\" href=\"{$this->settings['public_dir']}style_css/{$this->registry->output->skin['_csscacheid']}/ipb_ie.css\" />
		<![endif]-->
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__af3d749a22fa04a1dd6dc8e627adfc3f($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--/CSS-->
		<script type='text/javascript'>
		//<![CDATA[
...
function __f__d8a0e43179dfbc0cc37a86bb1eb9d3ae($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['import'] as $data )
...
function __f__62555185116a1cca8552ab1f23f198ba($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['inline'] as $data )
...
function __f__481dfc992a7596000439ac521201e84a($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems[ $type ] as $idx => $data )
...
function __f__af3d749a22fa04a1dd6dc8e627adfc3f($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__481dfc992a7596000439ac521201e84a($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_036f320109e2f2cb9b9063ae3e02141a = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_036f320109e2f2cb9b9063ae3e02141a]['member'] = $member;
$this->functionData['repButtons'][$count_036f320109e2f2cb9b9063ae3e02141a]['data'] = $data;
}
...
<div class='likepop fixed_inner'>
	<ul class='ipsList_withminiphoto'>
		".$this->__f__c6bafcf9217255b187f407d4c8a07e08($data,$relId)."	</ul>
</div>";
return $IPBHTML;
}


function __f__c6bafcf9217255b187f407d4c8a07e08($data, $relId)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data as $mid => $data )
...
$IPBHTML .= "<div>
	...
	<div class='ipsPad' style='min-height: 60px'>
		...
		") : ("".$this->__f__fda1ed51ca4dc40129b1831c0379852c($reps)."		")) . "
	</div>
</div>";
return $IPBHTML;
}
...
function __f__fda1ed51ca4dc40129b1831c0379852c($reps)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reps as $r )
...
{
$count_9ef1f745b8b4fb67d5f1825f5a81201f = is_array($this->functionData['socialSharePostStrip']) ? count($this->functionData['socialSharePostStrip']) : 0;
$this->functionData['socialSharePostStrip'][$count_9ef1f745b8b4fb67d5f1825f5a81201f]['id'] = $id;
}
...
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("facebook", "0" ) . "" . (($this->settings['sm_autoshare'] && IPSMember::canSocialShare()) ? ("<div class='ipsBox_container ipsMargin_top ipsPad_top'>
	<ul class='ipsPad ipsForm_vertical ipsList_inline ipsType_small clearfix'>
		".$this->__f__663b47560a670d6134c571e5f66a6d0e($id)."		" . ((! $id) ? ("
...
function __f__663b47560a670d6134c571e5f66a6d0e($id=null)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2783e097ee072bdeaa8139b900ff2bbb = is_array($this->functionData['tagCloud']) ? count($this->functionData['tagCloud']) : 0;
$this->functionData['tagCloud'][$count_2783e097ee072bdeaa8139b900ff2bbb]['tags'] = $tags;
}
$IPBHTML .= "" . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>{$this->lang->words['mob_tags']}</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
<div class='ipsBox'>
	<div class='ipsBox_container ipsPad'>
		<ul class='ipsList_inline'>
		".$this->__f__1bb8b286866a259c3ae3d226302ed08c($tags)."		</ul>
	</div>
</div>" . $this->registry->getClass('output')->getReplacement("box_end") . "";
return $IPBHTML;
}
...
function __f__1bb8b286866a259c3ae3d226302ed08c($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_72750bf70142f90565507bac0e41d69e = is_array($this->functionData['tagEntry']) ? count($this->functionData['tagEntry']) : 0;
$this->functionData['tagEntry'][$count_72750bf70142f90565507bac0e41d69e]['tag'] = $tag;
$this->functionData['tagEntry'][$count_72750bf70142f90565507bac0e41d69e]['noClass'] = $noClass;
$this->functionData['tagEntry'][$count_72750bf70142f90565507bac0e41d69e]['app'] = $app;
$this->functionData['tagEntry'][$count_72750bf70142f90565507bac0e41d69e]['section'] = $section;
}
...
{
$count_a5dd2646dd10c5ac8dbf9369a987ba1a = is_array($this->functionData['tagPrefix']) ? count($this->functionData['tagPrefix']) : 0;
$this->functionData['tagPrefix'][$count_a5dd2646dd10c5ac8dbf9369a987ba1a]['tag'] = $tag;
$this->functionData['tagPrefix'][$count_a5dd2646dd10c5ac8dbf9369a987ba1a]['app'] = $app;
$this->functionData['tagPrefix'][$count_a5dd2646dd10c5ac8dbf9369a987ba1a]['section'] = $section;
}
...
{
$count_0f7b0d4f2c05e17713e042af27465bd0 = is_array($this->functionData['tagTextEntryBox']) ? count($this->functionData['tagTextEntryBox']) : 0;
$this->functionData['tagTextEntryBox'][$count_0f7b0d4f2c05e17713e042af27465bd0]['tags'] = $tags;
$this->functionData['tagTextEntryBox'][$count_0f7b0d4f2c05e17713e042af27465bd0]['options'] = $options;
$this->functionData['tagTextEntryBox'][$count_0f7b0d4f2c05e17713e042af27465bd0]['where'] = $where;
}
