...
$this->_funcHooks['sendReplyForm'] = array('replyerrors','replyForm','previewPm','formErrors','formHeaderText','attachmentForm','replyOptions');
...
{
$count_27efbf7dd73e2c44496acbe3f083ffa3 = is_array($this->functionData['messengerDisabled']) ? count($this->functionData['messengerDisabled']) : 0;
}
...
{
$count_f48c040efb8c4387380ca132309a9142 = is_array($this->functionData['messengerTemplate']) ? count($this->functionData['messengerTemplate']) : 0;
$this->functionData['messengerTemplate'][$count_f48c040efb8c4387380ca132309a9142]['html'] = $html;
$this->functionData['messengerTemplate'][$count_f48c040efb8c4387380ca132309a9142]['jumpmenu'] = $jumpmenu;
$this->functionData['messengerTemplate'][$count_f48c040efb8c4387380ca132309a9142]['dirData'] = $dirData;
$this->functionData['messengerTemplate'][$count_f48c040efb8c4387380ca132309a9142]['totalData'] = $totalData;
$this->functionData['messengerTemplate'][$count_f48c040efb8c4387380ca132309a9142]['topicParticipants'] = $topicParticipants;
$this->functionData['messengerTemplate'][$count_f48c040efb8c4387380ca132309a9142]['inlineError'] = $inlineError;
$this->functionData['messengerTemplate'][$count_f48c040efb8c4387380ca132309a9142]['deletedTopic'] = $deletedTopic;
}
...
<div id='messenger_utilities' class='left'>
	...
	" . ((is_array( $topicParticipants ) and count( $topicParticipants )) ? ("<div class='ipsSideBlock' id='participants'>
			...
			<ul id='participants_list' class='ipsList_withminiphoto fullList'>
				".$this->__f__b6e702d85dcf12eabbaf88fd5a6ebedb($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."					
			</ul>
	...
	<div id='folder_list' class='ipsSideBlock'>
		...
		<ol id='folders'>
			" . ((count($dirData)) ? ("
				".$this->__f__dc122c41fb95cc2281d937fe002730cf($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."			") : ("")) . "
		</ol>
...
function __f__b6e702d85dcf12eabbaf88fd5a6ebedb($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__dc122c41fb95cc2281d937fe002730cf($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6a9d34a938ef65864a308a77a07507bf = is_array($this->functionData['sendNewPersonalTopicForm']) ? count($this->functionData['sendNewPersonalTopicForm']) : 0;
$this->functionData['sendNewPersonalTopicForm'][$count_6a9d34a938ef65864a308a77a07507bf]['displayData'] = $displayData;
}
...
" . (($displayData['preview']) ? ("
	" . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>{$this->lang->words['pm_preview']}</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
	...
	<br />
") : ("")) . "
" . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>{$this->lang->words['mess_new']}</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
" . ((is_array($displayData['errors']) AND count($displayData['errors'])) ? ("
<div class='ipsPad'>
<div class='message error'>
	<h4>{$this->lang->words['err_errors']}</h4>
	".$this->__f__0942bd019952d8fb5a3da13a5fd6219e($displayData)."	<p>{$this->lang->words['pme_none_sent']}</p>
</div>
</div>
") : ("")) . "
...
function __f__0942bd019952d8fb5a3da13a5fd6219e($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_342d958c95effcccb92d90b9a1d49c1a = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_342d958c95effcccb92d90b9a1d49c1a]['displayData'] = $displayData;
}
$IPBHTML .= "<div id='message_compose' class='post_form'>
...
<div class='message error'>
    <h4>{$this->lang->words['err_errors']}</h4>
    ".$this->__f__1c3633ee9ad1e201ca55d1ee3841394f($displayData)."    <p>{$this->lang->words['pme_none_sent']}</p>
</div><br />
") : ("")) . "
...
function __f__1c3633ee9ad1e201ca55d1ee3841394f($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $displayData['errors'] as $_error )
...
{
$count_6d7cda5140511630360e63a9343ff56d = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_6d7cda5140511630360e63a9343ff56d]['topic'] = $topic;
$this->functionData['showConversation'][$count_6d7cda5140511630360e63a9343ff56d]['replies'] = $replies;
$this->functionData['showConversation'][$count_6d7cda5140511630360e63a9343ff56d]['members'] = $members;
$this->functionData['showConversation'][$count_6d7cda5140511630360e63a9343ff56d]['jump'] = $jump;
}
...
" . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>{$topic['mt_title']}</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
<div class='ipsBox removeDefault'>
	<div class='ipsBox_container'>
		".$this->__f__deb025196d5e32e4dfb3bf0f982357a6($topic,$replies,$members,$jump)."	</div>
</div>" . $this->registry->getClass('output')->getReplacement("box_end") . "

<div class='topic_controls clear'>
    {$topic['_pages']}
    <ul class='topic_buttons'>
         <li class='non_button'> <a id='email_convo_{$this->request['topicID']}' data-tooltip='" . sprintf( $this->lang->words['msg_email_convo_text'], $this->memberData['name']) . "' href='#' class='email_convo'>{$this->lang->words['msg_email_convo']}</a> </li>
    </ul>
</div>
...
") : ("" . (($topic['_canReply']) ? ("
" . $this->registry->getClass('output')->getReplacement("header_start") . "<h3 class='maintitle'>{$this->lang->words['pc_fast_reply']}</h3>" . $this->registry->getClass('output')->getReplacement("header_end") . "
	<div class='ipsBox removeDefault'>
		<div class='ipsBox_container ipsPad'>
...
function __f__deb025196d5e32e4dfb3bf0f982357a6($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
			...
			<div class='post_block first hentry column_view' id='post_id_{$msg['msg_id']}'>
				<div class='post_wrap'>
					...
					") : ("
						<h3>
					")) . "
							<div class='post_username'>" . (($members[ $msg['msg_author_id'] ]['member_id']) ? ("
							...
							")) . "</div><div class='post_date'>{$this->lang->words['pc_sent']} " . IPSText::htmlspecialchars($this->registry->getClass('class_localization')->getDate($msg['msg_date'],"long", 0)) . "</div>
					...
					<div class='post_body'>
						...
						<ul class='post_controls clearfix clear'>
							" . (($topic['_canReply'] AND empty( $topic['_everyoneElseHasLeft'] )) ? ("
								<li>
									<a href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=messaging&amp;section=send&amp;do=replyForm&amp;topicID={$topic['mt_id']}&amp;msgID={$msg['msg_id']}", "publicWithApp",'' ), "", "" ) . "\" title=\"{$this->lang->words['tt_reply_to_post']}\"><img src=\"{style_images_url}/comment_new.png\" alt=\"\" /> {$this->lang->words['pc_reply']}</a>
								</li>
							") : ("")) . "
							" . (($topic['_canReport'] and $this->memberData['member_id']) ? ("
								<li class='report'>
									<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=reports&amp;rcom=messages&amp;topicID={$this->request['topicID']}&amp;st={$this->request['st']}&amp;msg={$msg['msg_id']}", "public",'' ), "", "" ) . "'><img src=\"{style_images_url}/report.png\" alt=\"\" /> {$this->lang->words['pc_report']}</a>
								</li>
							") : ("")) . "
							" . (($msg['_canEdit'] === TRUE) ? ("
								<li class='post_edit' id='edit_post_{$msg['msg_id']}'>
									<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=messaging&amp;section=send&amp;do=editMessage&amp;topicID={$topic['mt_id']}&amp;msgID={$msg['msg_id']}", "publicWithApp",'' ), "", "" ) . "' title='{$this->lang->words['edit_this_post']}'><img src=\"{style_images_url}/comment_edit.png\" alt=\"\" /> {$this->lang->words['pc_edit']}</a>
								</li>
							") : ("")) . "
...
{
$count_897dd3152ba1e46bac0f9ee92df10d1b = is_array($this->functionData['showConversationForArchive']) ? count($this->functionData['showConversationForArchive']) : 0;
$this->functionData['showConversationForArchive'][$count_897dd3152ba1e46bac0f9ee92df10d1b]['topic'] = $topic;
$this->functionData['showConversationForArchive'][$count_897dd3152ba1e46bac0f9ee92df10d1b]['replies'] = $replies;
$this->functionData['showConversationForArchive'][$count_897dd3152ba1e46bac0f9ee92df10d1b]['members'] = $members;
}
...
$IPBHTML .= "<html>
	...
	<body>
		...
		<br />
		<br />
		".$this->__f__beaa54bc86d74ac89102703bb5c4008f($topic,$replies,$members)."	</body>
</html>";
return $IPBHTML;
}


function __f__beaa54bc86d74ac89102703bb5c4008f($topic, $replies, $members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $replies as $msg_id => $msg )
...
{
$count_0f797d95ce03f52925c0c17e886f9639 = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_0f797d95ce03f52925c0c17e886f9639]['messages'] = $messages;
$this->functionData['showFolder'][$count_0f797d95ce03f52925c0c17e886f9639]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_0f797d95ce03f52925c0c17e886f9639]['pages'] = $pages;
$this->functionData['showFolder'][$count_0f797d95ce03f52925c0c17e886f9639]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_0f797d95ce03f52925c0c17e886f9639]['jumpFolderHTML'] = $jumpFolderHTML;
}
...
<div id='message_list'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=messaging&amp;section=view&amp;do=multiFile&amp;cFolderID={$currentFolderID}", "public",'' ), "", "" ) . "\" id='msgFolderForm' method=\"post\">
		...
		<input type=\"hidden\" name=\"st\" value=\"{$this->request['st']}\" />
		<input type=\"hidden\" name=\"auth_key\" value=\"{$this->member->form_hash}\" />
		" . $this->registry->getClass('output')->getReplacement("header_start") . "<div class='maintitle'>
			<span class='right'>
		...
		<div class='ipsBox removeDefault'>
			<div class='ipsBox_container'>
				<table class='ipb_table' id='message_table'>
					...
					" . ((count( $messages )) ? ("
						".$this->__f__393734ee6fd612e55363dc8ab99dde09($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."					") : ("
						<tr>
...
function __f__0ecbf74311817580d465df91908a1a28($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML,$id='',$msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__393734ee6fd612e55363dc8ab99dde09($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							<tr id='{$msg['mt_id']}' class='" . (($msg['map_has_unread']) ? ("unread") : ("")) . "'>
								...
								<td class='col_m_subject'>
									...
									" . ((is_array( $msg['pages'] ) AND count( $msg['pages'] )) ? ("
										...
										".$this->__f__0ecbf74311817580d465df91908a1a28($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML,$id,$msg)."										</ul>
									") : ("")) . "
								</td>
...
{
$count_7ad162bfd8ccfc360ece8d760db15506 = is_array($this->functionData['showSearchResults']) ? count($this->functionData['showSearchResults']) : 0;
$this->functionData['showSearchResults'][$count_7ad162bfd8ccfc360ece8d760db15506]['messages'] = $messages;
$this->functionData['showSearchResults'][$count_7ad162bfd8ccfc360ece8d760db15506]['pages'] = $pages;
$this->functionData['showSearchResults'][$count_7ad162bfd8ccfc360ece8d760db15506]['error'] = $error;
}
$IPBHTML .= "<script type='text/javascript'>
//<![CDATA[
...
" . (($pages) ? ("
	...
	<br />
") : ("")) . "
" . $this->registry->getClass('output')->getReplacement("header_start") . "<h2 class='maintitle clear'>{$this->lang->words['your_search_results']}</h2>" . $this->registry->getClass('output')->getReplacement("header_end") . "
<div id='message_list'>
	<div class='ipsBox removeDefault'>
		<div class='ipsBox_container'>
			<table class='ipb_table' id='message_table'>
				...
				" . ((count( $messages )) ? ("
					".$this->__f__8fe448f3fc0056c30ddaa6c91f1c48ea($messages,$pages,$error)."				") : ("
					<tr>
...
function __f__8fe448f3fc0056c30ddaa6c91f1c48ea($messages, $pages, $error)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $messages as $id => $msg )
