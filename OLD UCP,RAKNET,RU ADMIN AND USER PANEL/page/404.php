...
$string = substr($_SESSION['query'], 0, 50);
$string = rtrim($string, "!,.-");
										...
										<div class=\"row\">
											<div class=\"col-xs-12 col-sm-12 col-md-12 col-lg-12\">
												<div class=\"text-center error-box\">
													...
													<h2 class=\"font-xl\"><strong><i class=\"fa fa-fw fa-warning fa-lg text-warning\"></i> Страница \"<u>{$url}/{$string}...</u>\" не найдена</strong></h2>
													<br />
												</div>
											</div>
										</div>
