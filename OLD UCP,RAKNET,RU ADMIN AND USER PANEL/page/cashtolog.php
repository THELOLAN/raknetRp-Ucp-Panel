												...
												<div class=\"table-responsive\" style=\"height: 700px; overflow: auto;\">							
													<form class=\"smart-form\" method=\"POST\" action=\"\" id=\"information\">
														<div class=\"input-group\">
															...
															<input class=\"form-control\" style=\"width: 160px;\" type=\"text\" placeholder=\"Введите номер аккаунта того кто передал\" name=\"userid\">
															<span class=\"input-group-addon\">
																<i class=\"fa fa-usd\"></i>
															</span>
...
$style->content( "{script}" , "<script type=\"text/javascript\">
									function info(){
										$.ajax({
											type: \"POST\",
											url: \"{$url}/lib/other/admin/cashtolog.php\",
